...
> TransformIssuedDocumentResponse TransformIssuedDocument (int companyId, decimal originalDocumentId, string newType, int? eInvoice = null, int? transformKeepCopy = null)
...
namespace Example
{
    public class TransformIssuedDocumentExample
    {
        public static void Main()
        {
            ...
            var apiInstance = new IssuedDocumentsApi(config);
            var companyId = 12345;  // int | The ID of the company.
            var originalDocumentId = 8.14D;  // decimal | Original document id.
...
|------|------|-------------|-------|
| **companyId** | **int** | The ID of the company. |  |
| **originalDocumentId** | **decimal** | Original document id. |  |
