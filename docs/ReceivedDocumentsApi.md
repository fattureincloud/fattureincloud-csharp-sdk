...
namespace Example
{
    public class GetReceivedDocumentPreCreateInfoExample
    {
        public static void Main()
        {
            ...
            var apiInstance = new ReceivedDocumentsApi(config);
            var companyId = 12345;  // int | The ID of the company.
            var type = type_example;  // string | The type of the received document.
...
> ListReceivedDocumentsResponse ListReceivedDocuments (int companyId, string type, string fields = null, string fieldset = null, string sort = null, int? page = null, int? perPage = null)
