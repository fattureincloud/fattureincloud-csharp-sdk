...
namespace It.FattureInCloud.Sdk.Test.Model
{
    ...
    {
        private readonly GetNewIssuedDocumentTotalsResponse instance;

        public GetNewIssuedDocumentTotalsResponseTests()
        {
            var body =
                "{ 'data': { 'amount_net': 68.18, 'taxable_amount': 68.18, 'vat_list': { '10': { 'amount_net': 68.18, 'amount_vat': 6.82 } }, 'amount_vat': 6.82, 'amount_gross': 75, 'amount_due': 75, 'payments_sum': 75 } }";
