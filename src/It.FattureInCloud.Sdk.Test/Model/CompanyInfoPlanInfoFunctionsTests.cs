...
namespace It.FattureInCloud.Sdk.Test.Model
{
    ...
    {
        private readonly CompanyInfoPlanInfoFunctions instance;

        public CompanyInfoPlanInfoFunctionsTests()
        {
            var body =
                "{ 'document_attachments': true, 'archive': true, 'payment_notifications': true, 'paypal': true, 'receipts': true, 'e_invoice': true, 'genius': true, 'stock': true, 'smtp': true, 'mail_tracking': true, 'subaccounts': true, 'tessera_sanitaria': true, 'recurring': true, 'sofort': false, 'cerved': true, 'ts_digital': true, 'ts_pay': true, 'ts_invoice_trading': true }";
