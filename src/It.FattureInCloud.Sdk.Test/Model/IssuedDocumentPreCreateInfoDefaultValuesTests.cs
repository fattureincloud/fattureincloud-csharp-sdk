...
namespace It.FattureInCloud.Sdk.Test.Model
{
    ...
    {
        private readonly IssuedDocumentPreCreateInfoDefaultValues instance;

        public IssuedDocumentPreCreateInfoDefaultValuesTests()
        {
            var body =
                "{ 'default_template': { 'id': 111, 'type': 'standard', 'name': 'Light Smoke' }, 'dn_template': { 'id': 222, 'type': 'delivery_note', 'name': 'DDT 1' }, 'ai_template': { 'id': 333, 'type': 'accompanying_invoice', 'name': 'FT Accompagnatoria 1' }, 'notes': '', 'rivalsa': 0, 'cassa': 0, 'withholding_tax': 0, 'withholding_tax_taxable': 100, 'other_withholding_tax': 0, 'use_gross_prices': false, 'payment_method': { 'id': 123321, 'name': 'Bonifico bancario', 'is_default': true, 'details': [ { 'title': 'Banca', 'description': 'Indesa' }, { 'title': 'IBAN', 'description': 'IT17QA12345600000003498936' }, { 'title': 'Intestatario', 'description': 'Mario Rossi' } ] } }";
