...
namespace It.FattureInCloud.Sdk.Test.Model
{
    ...
    {
        private readonly GetUserInfoResponseInfo instance;

        public GetUserInfoResponseInfoTests()
        {
            var body =
                "{ 'need_marketing_consents_confirmation': false, 'need_password_change': false, 'need_terms_of_service_confirmation': false }";
