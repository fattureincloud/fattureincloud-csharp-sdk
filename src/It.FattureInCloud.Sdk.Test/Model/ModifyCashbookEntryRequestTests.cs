...
namespace It.FattureInCloud.Sdk.Test.Model
{
    ...
    {
        private readonly ModifyCashbookEntryRequest instance;

        public ModifyCashbookEntryRequestTests()
        {
            var body =
                "{ 'data': { 'date': '2021-08-24', 'amount_in': 122, 'payment_account_in': { 'id': 333 }, 'description': 'Fattura n. 201/2021', 'entity_name': 'Rossi S.r.l.' } }";
