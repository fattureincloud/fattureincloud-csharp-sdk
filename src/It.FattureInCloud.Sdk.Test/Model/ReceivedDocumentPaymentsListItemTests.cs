...
namespace It.FattureInCloud.Sdk.Test.Model
{
    ...
    {
        private readonly ReceivedDocumentPaymentsListItem instance;

        public ReceivedDocumentPaymentsListItemTests()
        {
            var body =
                "{'amount':592,'due_date':'2021-08-15','paid_date':'2021-08-15','id':777,'payment_terms':{'days':0,'type':'standard'},'status':'paid','payment_account':{'id':222,'name':'Contanti','virtual':false}}";
