...
namespace It.FattureInCloud.Sdk.Test.Model
{
    ...
    {
        private readonly CashbookEntry instance;

        public CashbookEntryTests()
        {
            var body =
                "{ 'id': 12345, 'date': '2021-08-24', 'description': 'Fattura n. 201/2021', 'entity_name': 'Rossi S.r.l.', 'kind': 'issued_document', 'type': 'in', 'amount_in': 100, 'amount_out': 0, 'document': { 'id': 12345, 'type': 'issued_document', 'path': '/doc1.pdf' }, 'payment_account_in': { 'id': 333 }, 'payment_account_out': { 'id': 333 } }";
