...
namespace It.FattureInCloud.Sdk.Test.Model
{
    ...
    {
        private readonly ControlledCompany instance;

        public ControlledCompanyTests()
        {
            var body =
                "{ 'id': 12345, 'name': 'Studio Commercialista', 'tax_code': 'ABCSFN94T17A794K', 'type': 'accountant', 'access_token': '4ff5f0fe5abcd1d7157fa13ca72ab62b6183db0667a576a0e19164801c18c4f7362a848fa32dbb8c3a3f94c34f3df95', 'connection_id': 94566, 'access_token': 'ergaegwergq53wh65je5j' }";
