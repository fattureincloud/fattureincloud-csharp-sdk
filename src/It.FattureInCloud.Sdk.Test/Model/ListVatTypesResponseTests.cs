...
namespace It.FattureInCloud.Sdk.Test.Model
{
    ...
    {
        private readonly ListVatTypesResponse instance;

        public ListVatTypesResponseTests()
        {
            var body =
                "{ 'data': [ { 'id': 0, 'value': 22, 'description': 'Non imponibile art. 123', 'notes': 'IVA non imponibile ai sensi dell articolo 123, comma 2', 'e_invoice': false, 'ei_type': 2, 'ei_description': 'string', 'editable': true }, { 'id': 1010, 'value': 0, 'description': 'NON IMPONIBILE IVA EX ART. 8 COMMA 1 LETT.A', 'notes': '', 'e_invoice': false, 'ei_type': 0, 'ei_description': null, 'is_disabled': false, 'editable': true } ] }";
