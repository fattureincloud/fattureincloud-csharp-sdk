...
namespace It.FattureInCloud.Sdk.Test.Model
{
    ...
    {
        private readonly ListPaymentMethodsResponse instance;

        public ListPaymentMethodsResponseTests()
        {
            var body =
                "{ 'data': [ { 'id': 12345, 'name': 'Carta di credito', 'is_default': false, 'default_payment_account': null }, { 'id': 12346, 'name': 'Bonifico bancario', 'is_default': true, 'default_payment_account': null } ] }";
