...
namespace It.FattureInCloud.Sdk.Test.Model
{
    ...
    {
        private readonly PaymentMethod instance;

        public PaymentMethodTests()
        {
            var body =
                "{ 'id': 12346, 'name': 'Bonifico bancario', 'type': 'standard', 'bank_iban': 'ITPPIOJDI&9769IUH', 'bank_name': 'indesa', 'bank_beneficiary': 'me', 'is_default': true, 'details': [{ 'title':'t1' }], 'default_payment_account': { 'id': 21, 'name': 'n1' }, 'ei_payment_method': 'MP02'}";
