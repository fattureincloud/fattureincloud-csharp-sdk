...
namespace It.FattureInCloud.Sdk.Test.Model
{
    ...
    {
        private readonly ReceivedDocumentItemsListItem instance;

        public ReceivedDocumentItemsListItemTests()
        {
            var body =
                "{ 'id': 12345, 'product_id': 54321, 'code': 'pdr01', 'measure': 'very big', 'name': 'prod uan', 'net_price': 100, 'category': 'other', 'qty': 1, 'stock': 99, 'vat': { 'id': 1020, 'value': 0, 'description': 'PA Non imp art. 2', 'is_disabled': false } }";
