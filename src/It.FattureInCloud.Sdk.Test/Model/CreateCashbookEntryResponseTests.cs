...
namespace It.FattureInCloud.Sdk.Test.Model
{
    ...
    {
        private readonly CreateCashbookEntryResponse instance;

        public CreateCashbookEntryResponseTests()
        {
            var body =
                "{ 'data': { 'id': 54321, 'date': '2021-08-24', 'amount_in': 122, 'amount_out': 0, 'description': 'Fattura n. 201/2021', 'payment_account_in': { 'id': 21, 'name': 'Indesa - Carta conto' }, 'payment_account_out': { 'id': 21, 'name': 'Indesa - Carta conto' }, 'kind': 'cashbook', 'type': 'in' } }";
