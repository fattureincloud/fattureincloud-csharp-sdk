...
namespace It.FattureInCloud.Sdk.Test.Api
{
    ...
    {
        private readonly string listArchiveCategoriesResponseBody;
        private readonly string listCitiesResponseBody;
        private readonly string listCostCentersResponseBody;
        private readonly string listCountriesResponseBody;
        private readonly string listCurrenciesResponseBody;
        private readonly string listDeliveryNotesDefaultCausalsResponseBody;
        private readonly string listDetailedCountriesResponseBody;
        private readonly string listLanguagesResponseBody;
        private readonly string listPaymentAccountsResponseBody;
        private readonly string listPaymentMethodsResponseBody;
        private readonly string listProductCategoriesResponseBody;
        private readonly string listReceivedDocumentCategoriesResponseBody;
        private readonly string listRevenueCentersResponseBody;
        private readonly string listTemplatesResponseBody;
        private readonly string listUnitsOfMeasureResponseBody;
        private readonly string listVatTypesResponseBody;
        private Mock<IInfoApi> instance = new Mock<IInfoApi>();

        public InfoApiTests()
        {
            listArchiveCategoriesResponseBody =
                "{'data':['Altri documenti','Conferme dordine','Contratti','Dichiarazioni dei redditi','Documenti per detrazioni','Estratti conto bancari','Estratti conto carte di credito']}";
            var listArchiveCategoriesResponse =
                JsonConvert.DeserializeObject<ListArchiveCategoriesResponse>(listArchiveCategoriesResponseBody);
            instance
                .Setup(p => p.ListArchiveCategories(Moq.It.IsAny<int>()))
                .Returns(listArchiveCategoriesResponse);

            listCitiesResponseBody =
                "{'data':[{'postal_code':'89867','city':'Zungri','province':'VV'},{'postal_code':'83020','city':'Aiello del Sabato','province':'AV'},{'postal_code':'83011','city':'Altavilla Irpina','province':'AV'}]}";
            ...
            var listCostCentersResponse =
                JsonConvert.DeserializeObject<ListCostCentersResponse>(listCostCentersResponseBody);
            instance
            ...
            listDetailedCountriesResponseBody =
            ...
            var listDetailedCountriesResponse =
                JsonConvert.DeserializeObject<ListDetailedCountriesResponse>(listDetailedCountriesResponseBody);
            instance
                .Setup(p => p.ListDetailedCountries())
                .Returns(listDetailedCountriesResponse);

            listCurrenciesResponseBody =
                "{'data':[{'id':'AED','symbol':'AED','html_symbol':'AED','exchange_rate':'4.09500'},{'id':'EUR','symbol':'\u20ac','html_symbol':'€','exchange_rate':'1.00000'}]}";
            var listCurrenciesResponse =
                JsonConvert.DeserializeObject<ListCurrenciesResponse>(listCurrenciesResponseBody);
            instance
                .Setup(p => p.ListCurrencies())
                .Returns(listCurrenciesResponse);

            listDeliveryNotesDefaultCausalsResponseBody =
                "{'data':['Altri documenti','Conferme dordine','Contratti','Dichiarazioni dei redditi','Documenti per detrazioni','Estratti conto bancari','Estratti conto carte di credito']}";
            var listDeliveryNotesDefaultCausalsResponse =
                JsonConvert.DeserializeObject<ListDeliveryNotesDefaultCausalsResponse>(
                    listDeliveryNotesDefaultCausalsResponseBody);
            instance
            ...
            listPaymentAccountsResponseBody =
                "{'data':[{'id':21,'name':'Indesa - Carta conto','type':'standard','virtual':false},{'id':109,'name':'Indesa','type':'bank','iban':'IT17A1234563200000003498936','sia':'IN234','virtual':false}]}";
            var listPaymentAccountsResponse =
                JsonConvert.DeserializeObject<ListPaymentAccountsResponse>(listPaymentAccountsResponseBody);
            instance
                .Setup(p => p.ListPaymentAccounts(Moq.It.IsAny<int>(), Moq.It.IsAny<string>(), Moq.It.IsAny<string>(),
                    Moq.It.IsAny<string>()))
                .Returns(listPaymentAccountsResponse);

            listPaymentMethodsResponseBody =
                "{'data':[{'id':12345,'name':'Carta di credito','is_default':false},{'id':12346,'name':'Bonifico bancario','is_default':true}]}";
            var listPaymentMethodsResponse =
                JsonConvert.DeserializeObject<ListPaymentMethodsResponse>(listPaymentMethodsResponseBody);
            instance
                .Setup(p => p.ListPaymentMethods(Moq.It.IsAny<int>(), Moq.It.IsAny<string>(), Moq.It.IsAny<string>(),
                    Moq.It.IsAny<string>()))
                .Returns(listPaymentMethodsResponse);

            listProductCategoriesResponseBody = "{'data':['Alimentari','Arredamento']}";
            var listProductCategoriesResponse =
                JsonConvert.DeserializeObject<ListProductCategoriesResponse>(listProductCategoriesResponseBody);
            instance
                .Setup(p => p.ListProductCategories(Moq.It.IsAny<int>(), Moq.It.IsAny<string>()))
                .Returns(listProductCategoriesResponse);

            listReceivedDocumentCategoriesResponseBody =
                "{'data':['Telefono e internet','Assicurazioni e quote','Auto ed altri veicoli','Computer e accessori','Server e hosting']}";
            var listReceivedDocumentCategoriesResponse =
                JsonConvert.DeserializeObject<ListReceivedDocumentCategoriesResponse>(
                    listReceivedDocumentCategoriesResponseBody);
            instance
            ...
            var listRevenueCentersResponse =
                JsonConvert.DeserializeObject<ListRevenueCentersResponse>(listRevenueCentersResponseBody);
            instance
            ...
            var listUnitsOfMeasureResponse =
                JsonConvert.DeserializeObject<ListUnitsOfMeasureResponse>(listUnitsOfMeasureResponseBody);
            instance
                .Setup(p => p.ListUnitsOfMeasure())
                .Returns(listUnitsOfMeasureResponse);

            listVatTypesResponseBody =
                "{'data':[{'value':22.0,'description':'Non imponibile art. 123','notes':'IVA non imponibile ai sensi dell articolo 123, comma 2','e_invoice':true,'ei_type':'2','ei_description':'string','is_disabled':false},{'id':1010,'description':'NON IMPONIBILE IVA EX ART. 8 COMMA 1 LETT.A','notes':'','e_invoice':false,'ei_type':'0','is_disabled':false}]}";
