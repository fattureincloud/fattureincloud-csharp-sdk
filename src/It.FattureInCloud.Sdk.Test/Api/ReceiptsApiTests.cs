...
namespace It.FattureInCloud.Sdk.Test.Api
{
    ...
    {
        private readonly string createReceiptResponseBody;
        private readonly string getReceiptPreCreateInfoResponseBody;
        private readonly string getReceiptResponseBody;
        private readonly string getReceiptsMonthlyTotalsResponseBody;
        private readonly string listReceiptsResponseBody;
        private readonly string modifyReceiptResponseBody;
        private Mock<IReceiptsApi> instance = new Mock<IReceiptsApi>();

        public ReceiptsApiTests()
        {
            createReceiptResponseBody =
                "{ 'data': { 'type': 'sales_receipt', 'id': 12346, 'date': '2021-08-19', 'number': 6.0, 'numeration': 'REC006', 'amount_net': 8.2, 'amount_vat': 1.8, 'amount_gross': 10.0, 'use_gross_prices': true, 'description': 'cassa 1', 'rc_center': '', 'created_at': '2021-08-19 17:57:56', 'updated_at': '2021-08-19 17:57:56', 'payment_account': { 'id': 555, 'name': 'contanti', 'virtual': false }, 'items_list': [ { 'id': 888, 'amount_net': 8.2, 'amount_gross': 10.0, 'category': 'altro', 'vat': { 'value': 22.0, 'description': 'iva', 'e_invoice': false, 'is_disabled': false } } ] }}";
            ...
            getReceiptResponseBody =
                "{ 'data': { 'type': 'sales_receipt', 'id': 12346, 'date': '2021-08-19', 'number': 6.0, 'numeration': 'REC006', 'amount_net': 8.2, 'amount_vat': 1.8, 'amount_gross': 10.0, 'use_gross_prices': true, 'description': 'cassa 1', 'rc_center': '', 'created_at': '2021-08-19 17:57:56', 'updated_at': '2021-08-19 17:57:56', 'payment_account': { 'id': 555, 'name': 'contanti', 'virtual': false }, 'items_list': [ { 'id': 888, 'amount_net': 8.2, 'amount_gross': 10.0, 'category': 'altro', 'vat': { 'value': 22.0, 'description': 'iva', 'e_invoice': false, 'is_disabled': false } } ] }}";
            var getReceiptResponse = JsonConvert.DeserializeObject<GetReceiptResponse>(getReceiptResponseBody);
            instance
                .Setup(p => p.GetReceipt(Moq.It.IsAny<int>(), Moq.It.IsAny<int>(), Moq.It.IsAny<string>(),
                    Moq.It.IsAny<string>()))
                .Returns(getReceiptResponse);

            getReceiptPreCreateInfoResponseBody =
            ...
            var getReceiptPreCreateInfoResponse =
                JsonConvert.DeserializeObject<GetReceiptPreCreateInfoResponse>(getReceiptPreCreateInfoResponseBody);
            instance
                .Setup(p => p.GetReceiptPreCreateInfo(Moq.It.IsAny<int>()))
                .Returns(getReceiptPreCreateInfoResponse);

            getReceiptsMonthlyTotalsResponseBody =
            ...
            var getReceiptsMonthlyTotalsResponse =
                JsonConvert.DeserializeObject<GetReceiptsMonthlyTotalsResponse>(getReceiptsMonthlyTotalsResponseBody);
            instance
                .Setup(p => p.GetReceiptsMonthlyTotals(Moq.It.IsAny<int>(), Moq.It.IsAny<string>(),
                    Moq.It.IsAny<string>()))
            ...
            instance
                .Setup(p => p.ListReceipts(Moq.It.IsAny<int>(), Moq.It.IsAny<string>(), Moq.It.IsAny<string>(),
                    Moq.It.IsAny<int>(), Moq.It.IsAny<int>(), Moq.It.IsAny<string>(), Moq.It.IsAny<string>()))
                .Returns(listReceiptsResponse);

            modifyReceiptResponseBody =
                "{ 'data': { 'type': 'sales_receipt', 'id': 12346, 'date': '2021-08-19', 'number': 6.0, 'numeration': 'REC006', 'amount_net': 8.2, 'amount_vat': 1.8, 'amount_gross': 10.0, 'use_gross_prices': true, 'description': 'cassa 1', 'rc_center': '', 'created_at': '2021-08-19 17:57:56', 'updated_at': '2021-08-19 17:57:56', 'payment_account': { 'id': 555, 'name': 'contanti', 'virtual': false }, 'items_list': [ { 'id': 888, 'amount_net': 8.2, 'amount_gross': 10.0, 'category': 'altro', 'vat': { 'value': 22.0, 'description': 'iva', 'e_invoice': false, 'is_disabled': false } } ] }}";
            var modifyReceiptResponse = JsonConvert.DeserializeObject<ModifyReceiptResponse>(modifyReceiptResponseBody);
            instance
                .Setup(p => p.ModifyReceipt(Moq.It.IsAny<int>(), Moq.It.IsAny<int>(),
                    Moq.It.IsAny<ModifyReceiptRequest>()))
        ...
        {
            var companyId = 2;
            var createReceiptRequest = new CreateReceiptRequest();
        ...
        public void ModifyReceiptTest()
        {
            var companyId = 2;
            var documentId = 12345;
            var modifyReceiptRequest = new ModifyReceiptRequest();
