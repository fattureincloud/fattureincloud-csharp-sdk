...
namespace It.FattureInCloud.Sdk.Test.Api
{
    ...
    public class ReceiptsApiTests : IDisposable
    {
        ...
        public ReceiptsApiTests()
        {
            ...
            instance
                .Setup(p => p.ListReceipts(Moq.It.IsAny<int>(), Moq.It.IsAny<string>(), Moq.It.IsAny<string>(), Moq.It.IsAny<int>(), Moq.It.IsAny<int>(), Moq.It.IsAny<string>(), Moq.It.IsAny<string>()))
