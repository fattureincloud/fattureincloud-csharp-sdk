...
namespace It.FattureInCloud.Sdk.Test.Api
{
    ...
    public class IssuedDocumentsApiTests : IDisposable
    {
        ...
        public IssuedDocumentsApiTests()
        {
            ...
            instance
                .Setup(p => p.ListIssuedDocuments(Moq.It.IsAny<int>(), Moq.It.IsAny<string>(), Moq.It.IsAny<string>(), Moq.It.IsAny<string>(), Moq.It.IsAny<string>(), Moq.It.IsAny<int?>(), Moq.It.IsAny<int?>(), Moq.It.IsAny<string>()))
