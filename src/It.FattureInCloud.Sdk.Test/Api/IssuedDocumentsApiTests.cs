...
namespace It.FattureInCloud.Sdk.Test.Api
{
    ...
    public class IssuedDocumentsApiTests : IDisposable
    {
        ...
        public IssuedDocumentsApiTests()
        {
            ...
            modifyIssuedDocumentResponseBody = "{ 'data': { 'type': 'receipt', 'show_totals': 'all', 'id': 12345, 'number': 1, 'numeration': 'rec123', 'date': '2021-08-20', 'currency': { 'id': 'EUR', 'symbol': '€', 'exchange_rate': '1.00000' }, 'language': { 'code': 'it', 'name': 'Italiano' }, 'subject': '', 'visible_subject': '', 'rc_center': '', 'notes': '', 'withholding_tax_taxable': 100.0, 'payment_method': { 'id': 4, 'name': 'Credit card', 'is_default': false, 'default_payment_account': null, 'details': null, 'bank_iban': null, 'bank_name': null, 'bank_beneficiary': null }, 'use_split_payment': false, 'use_gross_prices': false, 'e_invoice': false, 'ei_data': null, 'items_list': [ { 'product_id': 5432, 'code': 'SG3', 'name': 'Soggiorno', 'description': '', 'qty': 1.0, 'measure': '', 'net_price': 68.18182, 'gross_price': 75.0, 'vat': { 'id': 3, 'value': 10.0, 'description': '', 'e_invoice': false, 'is_disabled': false }, 'not_taxable': false, 'apply_withholding_taxes': true, 'discount_highlight': false, 'in_ddt': false, 'stock': false } ], 'payments_list': [ { 'status': 'not_paid', 'due_date': '2020-08-23', 'amount': 75.0, 'payment_account': null, 'paid_date': '2020-08-23', 'ei_raw': null } ], 'template': { 'id': 2821, 'name': 'Light Smoke' }, 'h_margins': 15, 'show_payments': true, 'show_payment_method': false, 'v_margins': 16, 'show_paypal_button': true, 'show_notification_button': false, 'delivery_note': false, 'accompanying_invoice': false, 'dn_ai_packages_number': null, 'dn_ai_weight': null, 'dn_ai_causal': null, 'dn_ai_destination': null, 'dn_ai_transporter': null, 'dn_ai_notes': null, 'is_marked': false, 'extra_data': null, 'seen_date': null, 'next_due_date': '2020-08-23', 'url': 'y12h45rn9yf2mse0p43t7ec90vr.pdf', 'attachment_token': null, 'ei_raw': null, 'show_tspay_button': false, 'year': 2021, 'amount_rivalsa_taxable': null, 'amount_global_cassa_taxable': null, 'amount_cassa_taxable': null, 'amount_cassa2': null, 'amount_cassa2_taxable': null, 'amount_withholding_tax_taxable': null, 'amount_enasarco_taxable': null, 'amount_other_withholding_tax_taxable': null, 'ei_cassa_type': null, 'ei_cassa2_type': null, 'ei_withholding_tax_causal': null, 'ei_other_withholding_tax_type': null, 'ei_other_withholding_tax_causal': null } }";
