...
namespace It.FattureInCloud.Sdk.Test.Api
{
    ...
    public class ClientsApiTests : IDisposable
    {
        ...
        public ClientsApiTests()
        {
            ...
            instance
                .Setup(p => p.ListClients(Moq.It.IsAny<int>(), Moq.It.IsAny<string>(), Moq.It.IsAny<string>(), Moq.It.IsAny<string>(), Moq.It.IsAny<int>(), Moq.It.IsAny<int>(), Moq.It.IsAny<string>()))
