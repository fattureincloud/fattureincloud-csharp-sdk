...
namespace It.FattureInCloud.Sdk.Test.Api
{
    ...
    {
        private readonly string createClientResponseBody;
        private readonly string getClientResponseBody;
        private readonly string listClientsResponseBody;
        private readonly string modifyClientResponseBody;
        private Mock<IClientsApi> instance = new Mock<IClientsApi>();
        ...
        public ClientsApiTests()
        {
            ...
            instance
                .Setup(p => p.ModifyClient(Moq.It.IsAny<int>(), Moq.It.IsAny<int>(),
                    Moq.It.IsAny<ModifyClientRequest>()))
        ...
        public void ModifyClientTest()
        {
            var companyId = 2;
            var clientId = 12345;
            var modifyClientRequest = new ModifyClientRequest();
