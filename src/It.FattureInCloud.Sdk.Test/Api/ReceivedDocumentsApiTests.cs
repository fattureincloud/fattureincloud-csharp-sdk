...
namespace It.FattureInCloud.Sdk.Test.Api
{
    ...
    {
        private readonly string createReceivedDocumentResponseBody;
        private readonly string getExistingReceivedDocumentTotalsResponseBody;
        private readonly string getNewReceivedDocumentTotalsResponseBody;
        private readonly string getReceivedDocumentPreCreateInfoResponseBody;
        private readonly string getReceivedDocumentResponseBody;
        private readonly string listReceivedDocumentsResponseBody;
        private readonly string modifyReceivedDocumentResponseBody;
        private readonly string uploadReceivedDocumentAttachmentResponseBody;
        private Mock<IReceivedDocumentsApi> instance = new Mock<IReceivedDocumentsApi>();

        public ReceivedDocumentsApiTests()
        {
            createReceivedDocumentResponseBody =
            ...
            var createReceivedDocumentResponse =
                JsonConvert.DeserializeObject<CreateReceivedDocumentResponse>(createReceivedDocumentResponseBody);
            instance
                .Setup(
                    p => p.CreateReceivedDocument(Moq.It.IsAny<int>(), Moq.It.IsAny<CreateReceivedDocumentRequest>()))
                .Returns(createReceivedDocumentResponse);

            getReceivedDocumentResponseBody =
                "{ 'data': { 'type': 'expense', 'entity': { 'id': 111, 'name': 'Hotel Rubino Palace' }, 'date': '2021-08-15', 'description': 'Soggiorno di lavoro', 'amount_net': 592.0, 'amortization': 1.0, 'rc_center': '', 'invoice_number': '', 'is_marked': false, 'is_detailed': false, 'e_invoice': false, 'currency': { 'id': 'EUR', 'symbol': '€', 'exchange_rate': '1.00000' }, 'tax_deductibility': 50.0, 'vat_deductibility': 100.0, 'payments_list': [ { 'id': 777, 'amount': 592.0, 'due_date': '2021-08-15', 'paid_date': '2021-08-15', 'payment_terms': { 'type': 'standard' }, 'status': 'paid', 'payment_account': { 'id': 222, 'name': 'Contanti', 'virtual': false } } ], 'attachment_token': 'bnopjao8gvydtgnewgiovs74yrfqwefEF' }}";
            var getReceivedDocumentResponse =
                JsonConvert.DeserializeObject<GetReceivedDocumentResponse>(getReceivedDocumentResponseBody);
            instance
                .Setup(p => p.GetReceivedDocument(Moq.It.IsAny<int>(), Moq.It.IsAny<int>(), Moq.It.IsAny<string>(),
                    Moq.It.IsAny<string>()))
            ...
            var getReceivedDocumentPreCreateInfoResponse =
                JsonConvert.DeserializeObject<GetReceivedDocumentPreCreateInfoResponse>(
                    getReceivedDocumentPreCreateInfoResponseBody);
            instance
            ...
            getExistingReceivedDocumentTotalsResponseBody =
                "{ 'data': { 'amount_net': 592.0, 'amount_vat': 20.0, 'amount_gross': 612.0, 'amount_due': 612.0, 'payments_sum': 592.0 }}";
            var getExistingReceivedDocumentsTotalsResponse =
                JsonConvert.DeserializeObject<GetExistingReceivedDocumentTotalsResponse>(
                    getExistingReceivedDocumentTotalsResponseBody);
            instance
                .Setup(p => p.GetExistingReceivedDocumentTotals(Moq.It.IsAny<int>(), Moq.It.IsAny<int>(),
                    Moq.It.IsAny<GetExistingReceivedDocumentTotalsRequest>()))
                .Returns(getExistingReceivedDocumentsTotalsResponse);

            getNewReceivedDocumentTotalsResponseBody =
                "{ 'data': { 'amount_net': 592.0, 'amount_vat': 20.0, 'amount_gross': 612.0, 'amount_due': 612.0, 'payments_sum': 592.0 }}";
            var getNewReceivedDocumentsTotalsResponse =
                JsonConvert.DeserializeObject<GetNewReceivedDocumentTotalsResponse>(
                    getNewReceivedDocumentTotalsResponseBody);
            instance
                .Setup(p => p.GetNewReceivedDocumentTotals(Moq.It.IsAny<int>(),
                    Moq.It.IsAny<GetNewReceivedDocumentTotalsRequest>()))
                .Returns(getNewReceivedDocumentsTotalsResponse);

            listReceivedDocumentsResponseBody =
                "{ 'current_page': 1, 'first_page_url': 'page=1', 'from': 1, 'last_page': 2, 'last_page_url': 'page=2', 'next_page_url': 'page=2', 'path': 'received_documents', 'per_page': 50, 'to': 50, 'total': 123, 'data': [ { 'type': 'expense', 'id': 12345, 'entity': { 'id': 111, 'name': 'Hotel Rubino Palace' }, 'date': '2021-08-15', 'description': 'Soggiorno di lavoro', 'amount_net': 592.0, 'amortization': 1.0, 'rc_center': '', 'invoice_number': '', 'is_marked': false, 'is_detailed': false, 'e_invoice': false, 'currency': { 'id': 'EUR', 'symbol': '€', 'exchange_rate': '1.00000' }, 'tax_deductibility': 50.0, 'vat_deductibility': 100.0, 'payments_list': [ { 'id': 777, 'amount': 592.0, 'due_date': '2021-08-15', 'paid_date': '2021-08-15', 'payment_terms': { 'type': 'standard' }, 'status': 'paid', 'payment_account': { 'id': 222, 'name': 'Contanti', 'virtual': false } } ] }, { 'id': 12346, 'type': 'expense', 'entity': { 'id': 89, 'name': 'Indesa Assicurazioni S.P.A.' }, 'date': '2021-08-08', 'description': 'Assicurazione RCA', 'amount_net': 645.69, 'rc_center': '', 'invoice_number': '', 'is_marked': false, 'is_detailed': false, 'e_invoice': false, 'currency': { 'id': 'EUR', 'symbol': '€', 'exchange_rate': '1.00000' }, 'tax_deductibility': 50.0, 'vat_deductibility': 100.0, 'payments_list': [ { 'id': 999, 'amount': 645.69, 'due_date': '2021-08-08', 'paid_date': '2021-08-08', 'payment_terms': { 'type': 'standard' }, 'status': 'paid', 'payment_account': { 'id': 333, 'name': 'Carta conto', 'virtual': false } } ] } ]}";
            var listReceivedDocumentsResponse =
                JsonConvert.DeserializeObject<ListReceivedDocumentsResponse>(listReceivedDocumentsResponseBody);
            instance
                .Setup(p => p.ListReceivedDocuments(Moq.It.IsAny<int>(), Moq.It.IsAny<string>(), Moq.It.IsAny<string>(),
            ...
            modifyReceivedDocumentResponseBody =
                "{ 'data': { 'type': 'expense', 'entity': { 'id': 111, 'name': 'Hotel Rubino Palace' }, 'date': '2021-08-15', 'description': 'Soggiorno di lavoro', 'amount_net': 592.0, 'amortization': 1.0, 'rc_center': '', 'invoice_number': '', 'is_marked': false, 'is_detailed': false, 'e_invoice': false, 'currency': { 'id': 'EUR', 'symbol': '€', 'exchange_rate': '1.00000' }, 'tax_deductibility': 50.0, 'vat_deductibility': 100.0, 'payments_list': [ { 'id': 777, 'amount': 592.0, 'due_date': '2021-08-15', 'paid_date': '2021-08-15', 'payment_terms': { 'type': 'standard' }, 'status': 'paid', 'payment_account': { 'id': 222, 'name': 'Contanti', 'virtual': false } } ], 'attachment_token': 'bnopjao8gvydtgnewgiovs74yrfqwefEF' }}";
            var modifyReceivedDocumentResponse =
                JsonConvert.DeserializeObject<ModifyReceivedDocumentResponse>(modifyReceivedDocumentResponseBody);
            instance
                .Setup(p => p.ModifyReceivedDocument(Moq.It.IsAny<int>(), Moq.It.IsAny<int>(),
                    Moq.It.IsAny<ModifyReceivedDocumentRequest>()))
                .Returns(modifyReceivedDocumentResponse);

            uploadReceivedDocumentAttachmentResponseBody =
                "{'data':{'attachment_token':'YmMyNWYxYzIwMTU3N2Y4ZGE3ZjZiMzg5OWY0ODNkZDQveXl5LmRvYw'}}";
            var uploadReceivedDocumentAttachmentResponse =
                JsonConvert.DeserializeObject<UploadReceivedDocumentAttachmentResponse>(
                    uploadReceivedDocumentAttachmentResponseBody);
            instance
                .Setup(p => p.UploadReceivedDocumentAttachment(Moq.It.IsAny<int>(), Moq.It.IsAny<string>(),
                    Moq.It.IsAny<Stream>()))
        ...
        {
            var companyId = 2;
            var createReceivedDocumentRequest = new CreateReceivedDocumentRequest();
        ...
        public void GetExistingReceivedDocumentTotalsTest()
        {
            ...
            var getExistingReceivedDocumentTotalsRequest = new GetExistingReceivedDocumentTotalsRequest();

            var response = instance.Object.GetExistingReceivedDocumentTotals(companyId, documentId,
        ...
        {
            var companyId = 2;
            var getNewReceivedDocumentTotalsRequest = new GetNewReceivedDocumentTotalsRequest();
        ...
        public void ListReceivedDocumentsTest()
        {
            ...
            var response =
                instance.Object.ListReceivedDocuments(companyId, type, fields, fieldset, sort, page, perPage);
        ...
        public void ModifyReceivedDocumentTest()
        {
            var companyId = 2;
            var documentId = 12345;
            var modifyReceivedDocumentRequest = new ModifyReceivedDocumentRequest();
