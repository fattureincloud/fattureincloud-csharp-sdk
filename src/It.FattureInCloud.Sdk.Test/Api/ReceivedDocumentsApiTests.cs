...
namespace It.FattureInCloud.Sdk.Test.Api
{
    ...
    public class ReceivedDocumentsApiTests : IDisposable
    {
        ...
        public ReceivedDocumentsApiTests()
        {
            ...
            instance
                .Setup(p => p.ListReceivedDocuments(Moq.It.IsAny<int>(), Moq.It.IsAny<string>(), Moq.It.IsAny<string>(), Moq.It.IsAny<string>(), Moq.It.IsAny<string>(), Moq.It.IsAny<int>(), Moq.It.IsAny<int>(), Moq.It.IsAny<string>()))
