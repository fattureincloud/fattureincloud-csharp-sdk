...
namespace It.FattureInCloud.Sdk.Test.Api
{
    ...
    {
        private readonly string createSupplierResponseBody;
        private readonly string getSupplierResponseBody;
        private readonly string listSuppliersResponseBody;
        private readonly string modifySupplierResponseBody;
        private Mock<ISuppliersApi> instance = new Mock<ISuppliersApi>();
        ...
        public SuppliersApiTests()
        {
            ...
            var createSupplierResponse =
                JsonConvert.DeserializeObject<CreateSupplierResponse>(createSupplierResponseBody);
            instance
            ...
            modifySupplierResponseBody =
                "{ 'data': { 'type': 'company', 'id': 12345, 'code': 'AE86', 'name': 'Mario Rossi S.R.L.', 'first_name': 'Mario', 'last_name': 'Rossi', 'contact_person': '', 'vat_number': '111222333', 'tax_code': '111122233', 'address_street': 'Corso Magellano, 46', 'address_postal_code': '20146', 'address_city': 'Milano', 'address_province': 'MI', 'address_extra': '', 'country': 'Italia', 'email': 'mario.rossi@example.com', 'certified_email': 'mario.rossi@pec.example.com', 'phone': '1234567890', 'fax': '123456789', 'notes': '' }}";
            var modifySupplierResponse =
                JsonConvert.DeserializeObject<ModifySupplierResponse>(modifySupplierResponseBody);
            instance
                .Setup(p => p.ModifySupplier(Moq.It.IsAny<int>(), Moq.It.IsAny<int>(),
                    Moq.It.IsAny<ModifySupplierRequest>()))
        ...
        public void ModifySupplierTest()
        {
            var companyId = 2;
            var supplierId = 12345;
            var modifySupplierRequest = new ModifySupplierRequest();
