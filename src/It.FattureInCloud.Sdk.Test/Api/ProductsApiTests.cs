...
namespace It.FattureInCloud.Sdk.Test.Api
{
    ...
    {
        private readonly string createProductResponseBody;
        private readonly string getProductResponseBody;
        private readonly string listProductsResponseBody;
        private readonly string modifyProductResponseBody;
        private Mock<IProductsApi> instance = new Mock<IProductsApi>();
        ...
        public ProductsApiTests()
        {
            ...
            instance
                .Setup(p => p.GetProduct(Moq.It.IsAny<int>(), Moq.It.IsAny<int>(), Moq.It.IsAny<string>(),
                    Moq.It.IsAny<string>()))
                .Returns(getProductResponse);

            listProductsResponseBody =
                "{ 'current_page': 1, 'first_page_url': 'page=1', 'from': 1, 'last_page': 1, 'last_page_url': 'page=1', 'next_page_url': 'page=2', 'path': 'products', 'per_page': 50, 'to': 55, 'total': 55, 'data': [ { 'id': 12345, 'name': 'Tavolo di marmo', 'code': 'TAVOLO003', 'net_price': 240.0, 'gross_price': 280.0, 'use_gross_price': false, 'default_vat': { 'id': 3, 'value': 22.0, 'description': 'Non imponibile art. 123', 'notes': 'IVA non imponibile ai sensi dell articolo 123, comma 2', 'e_invoice': false, 'is_disabled': false }, 'net_cost': 0.0, 'measure': '', 'description': 'Tavolo in marmo pregiato', 'category': 'arredamento', 'in_stock': true }, { 'id': 12346, 'name': 'Tavolo di legno', 'code': 'TAVOLO001', 'net_price': 120.0, 'gross_price': 160.0, 'use_gross_price': false, 'default_vat': { 'id': 3, 'value': 22.0, 'description': 'Non imponibile art. 123', 'notes': 'IVA non imponibile ai sensi dell articolo 123, comma 2', 'e_invoice': false, 'is_disabled': false }, 'net_cost': 0.0, 'measure': '', 'description': 'Tavolo in legno pregiato', 'in_stock': true, 'category': 'arredamento' } ] }";
            var listProductsResponse = JsonConvert.DeserializeObject<ListProductsResponse>(listProductsResponseBody);
            instance
                .Setup(p => p.ListProducts(Moq.It.IsAny<int>(), Moq.It.IsAny<string>(), Moq.It.IsAny<string>(),
            ...
            instance
                .Setup(p => p.ModifyProduct(Moq.It.IsAny<int>(), Moq.It.IsAny<int>(),
                    Moq.It.IsAny<ModifyProductRequest>()))
        ...
        public void ModifyProductTest()
        {
            var companyId = 2;
            var productId = 12345;
            var modifyProductRequest = new ModifyProductRequest();
