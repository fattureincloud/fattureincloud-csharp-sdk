...
namespace It.FattureInCloud.Sdk.Model
{
    ...
    public class ListArchiveDocumentsResponse : IEquatable<ListArchiveDocumentsResponse>, IValidatableObject
    {
        ...
        public ListArchiveDocumentsResponse(int? currentPage = default(int?), string firstPageUrl = default(string),
            ...
            List<ArchiveDocument> data = default(List<ArchiveDocument>))
        {
        ...
        {
            return Equals(input as ListArchiveDocumentsResponse);
        }
