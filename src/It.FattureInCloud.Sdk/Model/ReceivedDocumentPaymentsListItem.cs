...
namespace It.FattureInCloud.Sdk.Model
{
    ...
    public partial class ReceivedDocumentPaymentsListItem : IEquatable<ReceivedDocumentPaymentsListItem>, IValidatableObject
    {
        ...
        public ReceivedDocumentPaymentsListItem(int? id = default, decimal? amount = default, DateTime? dueDate = default, DateTime? paidDate = default, ReceivedDocumentPaymentsListItemPaymentTerms paymentTerms = default, string status = default, PaymentAccount paymentAccount = default)
        {
            this._Id = id;
            if (this.Id != null)
            {
