...
namespace It.FattureInCloud.Sdk.Model
{
    ...
    public class City : IEquatable<City>, IValidatableObject
    {
        ...
        public City(string postalCode = default(string), string city = default(string),
            string province = default(string))
        {
            _PostalCode = postalCode;
            if (PostalCode != null) _flagPostalCode = true;
            __City = city;
            if (_City != null) _flag_City = true;
            _Province = province;
            if (Province != null) _flagProvince = true;
        }
        ...
        public override int GetHashCode()
        {
            ...
            {
                int hashCode = 41;
                if (PostalCode != null) hashCode = hashCode * 59 + PostalCode.GetHashCode();
                if (_City != null) hashCode = hashCode * 59 + _City.GetHashCode();
