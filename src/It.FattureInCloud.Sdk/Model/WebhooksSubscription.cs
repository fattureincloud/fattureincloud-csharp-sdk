...
namespace It.FattureInCloud.Sdk.Model
{
    ...
    public partial class WebhooksSubscription : IEquatable<WebhooksSubscription>, IValidatableObject
    {
        ...
        public WebhooksSubscription(string id = default(string), string sink = default(string), bool? verified = default(bool?), List<EventType> types = default(List<EventType>))
        {
            this._Id = id;
            if (this.Id != null)
            {
