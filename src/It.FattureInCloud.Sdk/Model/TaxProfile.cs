...
namespace It.FattureInCloud.Sdk.Model
{
    ...
    public partial class TaxProfile : IEquatable<TaxProfile>, IValidatableObject
    {
        ...
        public TaxProfile(string companyType = default(string), string companySubtype = default(string), string profession = default(string), string regime = default(string), string rivalsaName = default(string), decimal defaultRivalsa = default(decimal), string cassaName = default(string), decimal defaultCassa = default(decimal), decimal defaultCassaTaxable = default(decimal), string cassa2Name = default(string), decimal defaultCassa2 = default(decimal), decimal defaultCassa2Taxable = default(decimal), decimal defaultWithholdingTax = default(decimal), decimal defaultWithholdingTaxTaxable = default(decimal), decimal defaultOtherWithholdingTax = default(decimal), bool enasarco = default(bool), string enasarcoType = default(string), decimal contributionsPercentage = default(decimal), decimal profitCoefficient = default(decimal), bool med = default(bool), VatType defaultVat = default(VatType))
        {
                    ...
                    switch (localVarJsonPropertyName)
                    {
                        ...
                        case "default_rivalsa":
                            if (utf8JsonReader.TokenType != JsonTokenType.Null)
                                defaultRivalsa = new Option<decimal?>(utf8JsonReader.GetDecimal());
                            break;
                        case "cassa_name":
                        ...
                        case "default_cassa":
                            if (utf8JsonReader.TokenType != JsonTokenType.Null)
                                defaultCassa = new Option<decimal?>(utf8JsonReader.GetDecimal());
                            break;
                        case "default_cassa_taxable":
                            if (utf8JsonReader.TokenType != JsonTokenType.Null)
                                defaultCassaTaxable = new Option<decimal?>(utf8JsonReader.GetDecimal());
                            break;
                        case "cassa2_name":
                        ...
                        case "default_cassa2":
                            if (utf8JsonReader.TokenType != JsonTokenType.Null)
                                defaultCassa2 = new Option<decimal?>(utf8JsonReader.GetDecimal());
                            break;
                        case "default_cassa2_taxable":
                            if (utf8JsonReader.TokenType != JsonTokenType.Null)
                                defaultCassa2Taxable = new Option<decimal?>(utf8JsonReader.GetDecimal());
                            break;
                        case "default_withholding_tax":
                            if (utf8JsonReader.TokenType != JsonTokenType.Null)
                                defaultWithholdingTax = new Option<decimal?>(utf8JsonReader.GetDecimal());
                            break;
                        case "default_withholding_tax_taxable":
                            if (utf8JsonReader.TokenType != JsonTokenType.Null)
                                defaultWithholdingTaxTaxable = new Option<decimal?>(utf8JsonReader.GetDecimal());
                            break;
                        case "default_other_withholding_tax":
                            if (utf8JsonReader.TokenType != JsonTokenType.Null)
                                defaultOtherWithholdingTax = new Option<decimal?>(utf8JsonReader.GetDecimal());
                            break;
                        case "enasarco":
                            if (utf8JsonReader.TokenType != JsonTokenType.Null)
                                enasarco = new Option<bool?>(utf8JsonReader.GetBoolean());
                            break;
                        case "enasarco_type":
                        ...
                        case "contributions_percentage":
                            if (utf8JsonReader.TokenType != JsonTokenType.Null)
                                contributionsPercentage = new Option<decimal?>(utf8JsonReader.GetDecimal());
                            break;
                        case "profit_coefficient":
                            if (utf8JsonReader.TokenType != JsonTokenType.Null)
                                profitCoefficient = new Option<decimal?>(utf8JsonReader.GetDecimal());
                            break;
                        case "med":
                            if (utf8JsonReader.TokenType != JsonTokenType.Null)
                                med = new Option<bool?>(utf8JsonReader.GetBoolean());
                            break;
                        case "default_vat":
                            if (utf8JsonReader.TokenType != JsonTokenType.Null)
