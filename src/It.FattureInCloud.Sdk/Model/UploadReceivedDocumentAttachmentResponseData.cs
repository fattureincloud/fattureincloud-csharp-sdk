...
namespace It.FattureInCloud.Sdk.Model
{
    ...
    public partial class UploadReceivedDocumentAttachmentResponseData : IEquatable<UploadReceivedDocumentAttachmentResponseData>, IValidatableObject
    {
        ...
        protected UploadReceivedDocumentAttachmentResponseData() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="UploadReceivedDocumentAttachmentResponseData" /> class.
        /// </summary>
        /// <param name="attachmentToken">Uploaded attachment token. (required).</param>
        public UploadReceivedDocumentAttachmentResponseData(string attachmentToken = default(string))
        {
            // to ensure "attachmentToken" is required (not null)
            if (attachmentToken == null) {
                throw new ArgumentNullException("attachmentToken is a required property for UploadReceivedDocumentAttachmentResponseData and cannot be null");
            }
        ...
        [DataMember(Name = "attachment_token", IsRequired = true, EmitDefaultValue = false)]
