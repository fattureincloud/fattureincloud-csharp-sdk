...
namespace It.FattureInCloud.Sdk.Model
{
    ...
    public partial class F24 : IEquatable<F24>, IValidatableObject
    {
        ...
        public F24(int? id = default, DateTime? dueDate = default, F24Status? status = default, PaymentAccount paymentAccount = default, decimal? amount = default, string attachmentToken = default, string description = default)
        {
            this._Id = id;
            if (this.Id != null)
            {
