...
namespace It.FattureInCloud.Sdk.Model
{
    ...
    public partial class Entity : IEquatable<Entity>, IValidatableObject
    {
        ...
        public Entity(int id = default(int), string code = default(string), string name = default(string), EntityType? type = default(EntityType?), string firstName = default(string), string lastName = default(string), string contactPerson = default(string), string vatNumber = default(string), string taxCode = default(string), string addressStreet = default(string), string addressPostalCode = default(string), string addressCity = default(string), string addressProvince = default(string), string addressExtra = default(string), string country = default(string), string countryIso = default(string), string email = default(string), string certifiedEmail = default(string), string phone = default(string), string fax = default(string), string notes = default(string), int defaultPaymentTerms = default(int), VatType defaultVat = default(VatType), PaymentTermsType? defaultPaymentTermsType = default(PaymentTermsType?), PaymentMethod defaultPaymentMethod = default(PaymentMethod), string bankName = default(string), string bankIban = default(string), string bankSwiftCode = default(string), string shippingAddress = default(string), bool eInvoice = default(bool), string eiCode = default(string), bool hasIntentDeclaration = default(bool), string intentDeclarationProtocolNumber = default(string), DateTimeOffset intentDeclarationProtocolDate = default(DateTimeOffset), string createdAt = default(string), string updatedAt = default(string))
        {
            this._Id = id;
            if (this.Id != null)
            {
