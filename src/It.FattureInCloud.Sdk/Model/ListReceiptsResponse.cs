...
namespace It.FattureInCloud.Sdk.Model
{
    ...
    /// </summary>
    public partial class ListReceiptsResponse : IValidatableObject
    {
        /// <summary>
        ...
        [JsonConstructor]
        public ListReceiptsResponse(Option<int?> currentPage = default, Option<string> firstPageUrl = default, Option<int?> from = default, Option<int?> lastPage = default, Option<string> lastPageUrl = default, Option<string> nextPageUrl = default, Option<string> path = default, Option<int?> perPage = default, Option<string> prevPageUrl = default, Option<int?> to = default, Option<int?> total = default, Option<List<Receipt>> data = default)
        {
        ...
        [JsonIgnore]
        [global::System.ComponentModel.EditorBrowsable(global::System.ComponentModel.EditorBrowsableState.Never)]
        public Option<List<Receipt>> DataOption { get; private set; }

        /// <summary>
        /// Gets or Sets Data
        /// </summary>
        [JsonPropertyName("data")]
        public List<Receipt> Data { get { return this.DataOption; } set { this.DataOption = new Option<List<Receipt>>(value); } }
