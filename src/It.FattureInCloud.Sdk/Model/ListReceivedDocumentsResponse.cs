...
namespace It.FattureInCloud.Sdk.Model
{
    ...
    public class ListReceivedDocumentsResponse : IEquatable<ListReceivedDocumentsResponse>, IValidatableObject
    {
        ...
        public ListReceivedDocumentsResponse(int? currentPage = default(int?), string firstPageUrl = default(string),
            ...
            List<ReceivedDocument> data = default(List<ReceivedDocument>))
        {
        ...
        {
            return Equals(input as ListReceivedDocumentsResponse);
        }
