...
namespace It.FattureInCloud.Sdk.Model
{
    ...
    public partial class ListReceivedDocumentsResponse : IEquatable<ListReceivedDocumentsResponse>, IValidatableObject
    {
        ...
        public ListReceivedDocumentsResponse(int currentPage = default(int), string firstPageUrl = default(string), int from = default(int), int lastPage = default(int), string lastPageUrl = default(string), string nextPageUrl = default(string), string path = default(string), int perPage = default(int), string prevPageUrl = default(string), int to = default(int), int total = default(int), List<ReceivedDocument> data = default(List<ReceivedDocument>))
        {
                    ...
                    switch (localVarJsonPropertyName)
                    {
                        case "current_page":
                            if (utf8JsonReader.TokenType != JsonTokenType.Null)
                                currentPage = new Option<int?>(utf8JsonReader.GetInt32());
                            break;
                        case "first_page_url":
                        ...
                        case "from":
                            if (utf8JsonReader.TokenType != JsonTokenType.Null)
                                from = new Option<int?>(utf8JsonReader.GetInt32());
                            break;
                        case "last_page":
                            if (utf8JsonReader.TokenType != JsonTokenType.Null)
                        ...
                        case "per_page":
                            if (utf8JsonReader.TokenType != JsonTokenType.Null)
                                perPage = new Option<int?>(utf8JsonReader.GetInt32());
                            break;
                        case "prev_page_url":
                        ...
                        case "to":
                            if (utf8JsonReader.TokenType != JsonTokenType.Null)
                                to = new Option<int?>(utf8JsonReader.GetInt32());
                            break;
                        case "total":
                            if (utf8JsonReader.TokenType != JsonTokenType.Null)
