...
namespace It.FattureInCloud.Sdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ListPendingReceivedDocumentsResponse")]
    public partial class ListPendingReceivedDocumentsResponse : IEquatable<ListPendingReceivedDocumentsResponse>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ListPendingReceivedDocumentsResponse" /> class.
        /// </summary>
        ...
        public ListPendingReceivedDocumentsResponse(int? currentPage = default, string firstPageUrl = default, int? from = default, int? lastPage = default, string lastPageUrl = default, string nextPageUrl = default, string path = default, int? perPage = default, string prevPageUrl = default, int? to = default, int? total = default, List<PendingReceivedDocument> data = default)
        {
        ...
        public List<PendingReceivedDocument> Data
        {
            get { return _Data; }
            set
            {
        ...
        private List<PendingReceivedDocument> _Data;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ListPendingReceivedDocumentsResponse {\n");
        ...
        {
            return this.Equals(input as ListPendingReceivedDocumentsResponse);
        }

        /// <summary>
        /// Returns true if ListPendingReceivedDocumentsResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of ListPendingReceivedDocumentsResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ListPendingReceivedDocumentsResponse input)
        {
            if (input == null)
            {
                return false;
