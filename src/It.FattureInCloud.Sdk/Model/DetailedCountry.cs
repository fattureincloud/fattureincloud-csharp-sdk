...
namespace It.FattureInCloud.Sdk.Model
{
    ...
    public partial class DetailedCountry : IEquatable<DetailedCountry>, IValidatableObject
    {
        ...
        public DetailedCountry(string name = default(string), string settingsName = default(string), string iso = default(string), string fiscalIso = default(string), string uic = default(string))
        {
            ...
            if (this.SettingsName != null) this._flagSettingsName = true;
            this._Iso = iso;
            if (this.Iso != null) this._flagIso = true;
            this._FiscalIso = fiscalIso;
            if (this.FiscalIso != null) this._flagFiscalIso = true;
            this._Uic = uic;
            if (this.Uic != null) this._flagUic = true;
        }
