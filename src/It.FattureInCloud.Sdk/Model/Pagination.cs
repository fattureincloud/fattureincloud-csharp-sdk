...
namespace It.FattureInCloud.Sdk.Model
{
    ...
    public partial class Pagination : IValidatableObject
    {
        ...
        [JsonConstructor]
        public Pagination(Option<int?> currentPage = default, Option<string> firstPageUrl = default, Option<int?> from = default, Option<int?> lastPage = default, Option<string> lastPageUrl = default, Option<string> nextPageUrl = default, Option<string> path = default, Option<int?> perPage = default, Option<string> prevPageUrl = default, Option<int?> to = default, Option<int?> total = default)
        {
