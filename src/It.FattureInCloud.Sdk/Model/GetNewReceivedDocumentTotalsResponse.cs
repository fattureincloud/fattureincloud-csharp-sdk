...
namespace It.FattureInCloud.Sdk.Model
{
    ...
    public class GetNewReceivedDocumentTotalsResponse : IEquatable<GetNewReceivedDocumentTotalsResponse>,
        IValidatableObject
    {
        ...
        {
            return Equals(input as GetNewReceivedDocumentTotalsResponse);
        }
