...
namespace It.FattureInCloud.Sdk.Model
{
    ...
    public partial class ReceivedDocument : IEquatable<ReceivedDocument>, IValidatableObject
    {
        ...
        /// </summary>
        /// <value>[Read Only] Received document e-invoice reception date, needs fic_view  fieldset</value>
        [DataMember(Name = "ei_reception_date", EmitDefaultValue = true)]
        public string EiReceptionDate { get; private set; }

        /// <summary>
        /// Returns false as EiReceptionDate should not be serialized given that it's read-only.
        /// </summary>
        /// <returns>false (boolean)</returns>
        public bool ShouldSerializeEiReceptionDate()
        {
            return false;
        }
        /// <summary>
        ...
        /// </summary>
        /// <value>[Read Only] True if received document is generated from pending expenses,  needs fic_view fieldset</value>
        [DataMember(Name = "is_from_pending_expenses", EmitDefaultValue = true)]
        public bool? IsFromPendingExpenses { get; private set; }

        /// <summary>
        /// Returns false as IsFromPendingExpenses should not be serialized given that it's read-only.
        /// </summary>
        /// <returns>false (boolean)</returns>
        public bool ShouldSerializeIsFromPendingExpenses()
        {
            return false;
        }
        /// <summary>
        ...
        public bool Equals(ReceivedDocument input)
        {
            ...
            return
                ...
                (
                    this.EiReceptionDate == input.EiReceptionDate ||
                    (this.EiReceptionDate != null &&
                    this.EiReceptionDate.Equals(input.EiReceptionDate))
                ) &&
                (
                    this.IsFromPendingExpenses == input.IsFromPendingExpenses ||
                    (this.IsFromPendingExpenses != null &&
                    this.IsFromPendingExpenses.Equals(input.IsFromPendingExpenses))
                );
        }
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.EiReceptionDate != null)
                {
                    hashCode = (hashCode * 59) + this.EiReceptionDate.GetHashCode();
                }
                if (this.IsFromPendingExpenses != null)
                {
                    hashCode = (hashCode * 59) + this.IsFromPendingExpenses.GetHashCode();
                }
                return hashCode;
            }
        }
