            ...
            while (utf8JsonReader.Read())
            {
                ...
                if (utf8JsonReader.TokenType == JsonTokenType.PropertyName && currentDepth == utf8JsonReader.CurrentDepth - 1)
                {
                    ...
                    switch (localVarJsonPropertyName)
                    {
                        ...
                        case "amortization":
                            if (utf8JsonReader.TokenType != JsonTokenType.Null)
                                amortization = new Option<decimal?>(utf8JsonReader.GetDecimal());
                            break;
                        case "rc_center":
                        ...
                        case "is_detailed":
                            if (utf8JsonReader.TokenType != JsonTokenType.Null)
                                isDetailed = new Option<bool?>(utf8JsonReader.GetBoolean());
                            break;
                        case "e_invoice":
                            if (utf8JsonReader.TokenType != JsonTokenType.Null)
                        ...
                        case "tax_deductibility":
                            if (utf8JsonReader.TokenType != JsonTokenType.Null)
                                taxDeductibility = new Option<decimal?>(utf8JsonReader.GetDecimal());
                            break;
                        case "vat_deductibility":
                            if (utf8JsonReader.TokenType != JsonTokenType.Null)
                                vatDeductibility = new Option<decimal?>(utf8JsonReader.GetDecimal());
                            break;
                        case "items_list":
                            if (utf8JsonReader.TokenType != JsonTokenType.Null)
                        ...
                        case "auto_calculate":
                            if (utf8JsonReader.TokenType != JsonTokenType.Null)
                                autoCalculate = new Option<bool?>(utf8JsonReader.GetBoolean());
                            break;
