...
namespace It.FattureInCloud.Sdk.Model
{
    ...
    public partial class ReceivedDocumentItemsListItem : IEquatable<ReceivedDocumentItemsListItem>, IValidatableObject
    {
        ...
        /// <param name="deductibilityVatPercentage">Received document item deductibility vat percentage.</param>
        public ReceivedDocumentItemsListItem(int? id = default, int? productId = default, string code = default, string name = default, string measure = default, decimal? netPrice = default, string category = default, decimal? qty = default, VatType vat = default, decimal? stock = default, decimal? deductibilityVatPercentage = default)
        {
            this._Id = id;
            if (this.Id != null)
            {
            ...
            this._DeductibilityVatPercentage = deductibilityVatPercentage;
            if (this.DeductibilityVatPercentage != null)
            {
                this._flagDeductibilityVatPercentage = true;
            }
        }
        ...
        /// </summary>
        /// <value>Received document item deductibility vat percentage</value>
        [DataMember(Name = "deductibility_vat_percentage", EmitDefaultValue = true)]
        public decimal? DeductibilityVatPercentage
        {
            get { return _DeductibilityVatPercentage; }
            set
            {
                _DeductibilityVatPercentage = value;
                _flagDeductibilityVatPercentage = true;
            }
        }
        private decimal? _DeductibilityVatPercentage;
        private bool _flagDeductibilityVatPercentage;

        /// <summary>
        /// Returns false as DeductibilityVatPercentage should not be serialized given that it's read-only.
        /// </summary>
        /// <returns>false (boolean)</returns>
        public bool ShouldSerializeDeductibilityVatPercentage()
        {
            return _flagDeductibilityVatPercentage;
        }
        /// <summary>
        ...
        public bool Equals(ReceivedDocumentItemsListItem input)
        {
            ...
            return
                ...
                (
                    this.DeductibilityVatPercentage == input.DeductibilityVatPercentage ||
                    (this.DeductibilityVatPercentage != null &&
                    this.DeductibilityVatPercentage.Equals(input.DeductibilityVatPercentage))
                );
        }
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.DeductibilityVatPercentage != null)
                {
                    hashCode = (hashCode * 59) + this.DeductibilityVatPercentage.GetHashCode();
                }
                return hashCode;
            }
        }
