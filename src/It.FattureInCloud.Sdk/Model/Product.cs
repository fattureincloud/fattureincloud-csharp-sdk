                ...
                if (utf8JsonReader.TokenType == JsonTokenType.PropertyName && currentDepth == utf8JsonReader.CurrentDepth - 1)
                {
                    ...
                    switch (localVarJsonPropertyName)
                    {
                        ...
                        case "use_gross_price":
                            if (utf8JsonReader.TokenType != JsonTokenType.Null)
                                useGrossPrice = new Option<bool?>(utf8JsonReader.GetBoolean());
                            break;
                        case "default_vat":
                            if (utf8JsonReader.TokenType != JsonTokenType.Null)
                        ...
                        case "net_cost":
                            if (utf8JsonReader.TokenType != JsonTokenType.Null)
                                netCost = new Option<decimal?>(utf8JsonReader.GetDecimal());
                            break;
                        case "measure":
                        ...
                        case "in_stock":
                            if (utf8JsonReader.TokenType != JsonTokenType.Null)
                                inStock = new Option<bool?>(utf8JsonReader.GetBoolean());
                            break;
                        case "stock_initial":
                            if (utf8JsonReader.TokenType != JsonTokenType.Null)
                                stockInitial = new Option<decimal?>(utf8JsonReader.GetDecimal());
                            break;
                        case "stock_current":
                            if (utf8JsonReader.TokenType != JsonTokenType.Null)
                                stockCurrent = new Option<decimal?>(utf8JsonReader.GetDecimal());
                            break;
                        case "average_cost":
                            if (utf8JsonReader.TokenType != JsonTokenType.Null)
                                averageCost = new Option<decimal?>(utf8JsonReader.GetDecimal());
                            break;
                        case "average_price":
                            if (utf8JsonReader.TokenType != JsonTokenType.Null)
                                averagePrice = new Option<decimal?>(utf8JsonReader.GetDecimal());
                            break;
                        case "created_at":
