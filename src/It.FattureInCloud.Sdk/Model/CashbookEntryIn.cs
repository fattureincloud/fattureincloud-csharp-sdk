...
namespace It.FattureInCloud.Sdk.Model
{
    ...
    public partial class CashbookEntryIn : IEquatable<CashbookEntryIn>, IValidatableObject
    {
        ...
        public CashbookEntryIn(string id = default(string), DateTimeOffset date = default(DateTimeOffset), string description = default(string), CashbookEntryKind? kind = default(CashbookEntryKind?), CashbookEntryType? type = default(CashbookEntryType?), string entityName = default(string), CashbookEntryDataDocument document = default(CashbookEntryDataDocument), decimal amountIn = default(decimal), PaymentAccount paymentAccountIn = default(PaymentAccount))
        {
            this.Id = id;
            this.Date = date;
