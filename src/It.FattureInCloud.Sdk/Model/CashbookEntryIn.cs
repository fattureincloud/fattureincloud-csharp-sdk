...
namespace It.FattureInCloud.Sdk.Model
{
    ...
    /// CashbookEntryIn
    /// </summary>
    [DataContract(Name = "CashbookEntryIn")]
    public partial class CashbookEntryIn : IEquatable<CashbookEntryIn>, IValidatableObject
    {
        /// <summary>
        /// Cashbook kind.
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="CashbookEntryIn" /> class.
        /// </summary>
        ...
        public CashbookEntryIn(string id = default(string), DateTimeOffset date = default(DateTimeOffset), string description = default(string), KindEnum? kind = default(KindEnum?), TypeEnum? type = default(TypeEnum?), string entityName = default(string), CashbookEntryDataDocument document = default(CashbookEntryDataDocument), decimal amountIn = default(decimal), PaymentAccount paymentAccountIn = default(PaymentAccount))
        {
            this.Id = id;
            this.Date = date;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CashbookEntryIn {\n");
        ...
        {
            return this.Equals(input as CashbookEntryIn);
        }

        /// <summary>
        /// Returns true if CashbookEntryIn instances are equal
        /// </summary>
        /// <param name="input">Instance of CashbookEntryIn to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CashbookEntryIn input)
        {
            if (input == null)
                return false;
