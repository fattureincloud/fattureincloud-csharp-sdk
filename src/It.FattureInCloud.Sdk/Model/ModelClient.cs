...
namespace It.FattureInCloud.Sdk.Model
{
    ...
    public partial class ModelClient : IEquatable<ModelClient>, IValidatableObject
    {
        ...
        public ModelClient(int id = default(int), string code = default(string), string name = default(string), ClientType? type = default(ClientType?), string firstName = default(string), string lastName = default(string), string contactPerson = default(string), string vatNumber = default(string), string taxCode = default(string), string addressStreet = default(string), string addressPostalCode = default(string), string addressCity = default(string), string addressProvince = default(string), string addressExtra = default(string), string country = default(string), string countryIso = default(string), string email = default(string), string certifiedEmail = default(string), string phone = default(string), string fax = default(string), string notes = default(string), VatType defaultVat = default(VatType), int defaultPaymentTerms = default(int), PaymentTermsType? defaultPaymentTermsType = default(PaymentTermsType?), PaymentMethod defaultPaymentMethod = default(PaymentMethod), string bankName = default(string), string bankIban = default(string), string bankSwiftCode = default(string), string shippingAddress = default(string), bool eInvoice = default(bool), bool discountHighlight = default(bool), string eiCode = default(string), decimal defaultDiscount = default(decimal), bool hasIntentDeclaration = default(bool), string intentDeclarationProtocolNumber = default(string), DateTimeOffset intentDeclarationProtocolDate = default(DateTimeOffset), string priceListId = default(string), string createdAt = default(string), string updatedAt = default(string))
        {
            this._Id = id;
            if (this.Id != null)
            {
        ...
        public DateTimeOffset IntentDeclarationProtocolDate
        {
        ...
        private DateTimeOffset _IntentDeclarationProtocolDate;
                ...
                if (utf8JsonReader.TokenType == JsonTokenType.PropertyName && currentDepth == utf8JsonReader.CurrentDepth - 1)
                {
                    ...
                    switch (localVarJsonPropertyName)
                    {
                        ...
                        case "default_payment_terms":
                            if (utf8JsonReader.TokenType != JsonTokenType.Null)
                                defaultPaymentTerms = new Option<int?>(utf8JsonReader.GetInt32());
                            break;
                        ...
                        case "discount_highlight":
                            if (utf8JsonReader.TokenType != JsonTokenType.Null)
                                discountHighlight = new Option<bool?>(utf8JsonReader.GetBoolean());
                            break;
                        case "ei_code":
                        ...
                        case "default_discount":
                            if (utf8JsonReader.TokenType != JsonTokenType.Null)
                                defaultDiscount = new Option<decimal?>(utf8JsonReader.GetDecimal());
                            break;
                        case "has_intent_declaration":
                            if (utf8JsonReader.TokenType != JsonTokenType.Null)
                                hasIntentDeclaration = new Option<bool?>(utf8JsonReader.GetBoolean());
                            break;
