...
namespace It.FattureInCloud.Sdk.Model
{
    ...
    public partial class ModelClient : IEquatable<ModelClient>, IValidatableObject
    {
        ...
        public ModelClient(int? id = default(int?), string code = default(string), string name = default(string), ClientType? type = default(ClientType?), string firstName = default(string), string lastName = default(string), string contactPerson = default(string), string vatNumber = default(string), string taxCode = default(string), string addressStreet = default(string), string addressPostalCode = default(string), string addressCity = default(string), string addressProvince = default(string), string addressExtra = default(string), string country = default(string), string email = default(string), string certifiedEmail = default(string), string phone = default(string), string fax = default(string), string notes = default(string), VatType defaultVat = default(VatType), int? defaultPaymentTerms = default(int?), PaymentTermsType? defaultPaymentTermsType = default(PaymentTermsType?), PaymentMethod defaultPaymentMethod = default(PaymentMethod), string bankName = default(string), string bankIban = default(string), string bankSwiftCode = default(string), string shippingAddress = default(string), bool? eInvoice = default(bool?), string eiCode = default(string), bool? discountHighlight = default(bool?), decimal? defaultDiscount = default(decimal?), bool? hasIntentDeclaration = default(bool?), string intentDeclarationProtocolNumber = default(string), DateTime? intentDeclarationProtocolDate = default(DateTime?), string createdAt = default(string), string updatedAt = default(string))
        {
            this._Id = id;
            if (this.Id != null)
            {
        ...
        public DateTime? IntentDeclarationProtocolDate
        {
        ...
        private DateTime? _IntentDeclarationProtocolDate;
