...
namespace It.FattureInCloud.Sdk.Model
{
    ...
    public partial class ModelClient : IEquatable<ModelClient>, IValidatableObject
    {
        ...
        public ModelClient(int? id = default(int?), string code = default(string), string name = default(string), ClientType? type = default(ClientType?), string firstName = default(string), string lastName = default(string), string contactPerson = default(string), string vatNumber = default(string), string taxCode = default(string), string addressStreet = default(string), string addressPostalCode = default(string), string addressCity = default(string), string addressProvince = default(string), string addressExtra = default(string), string country = default(string), string email = default(string), string certifiedEmail = default(string), string phone = default(string), string fax = default(string), string notes = default(string), VatType defaultVat = default(VatType), int? defaultPaymentTerms = default(int?), DefaultPaymentTermsType? defaultPaymentTermsType = default(DefaultPaymentTermsType?), PaymentMethod defaultPaymentMethod = default(PaymentMethod), string bankName = default(string), string bankIban = default(string), string bankSwiftCode = default(string), string shippingAddress = default(string), bool? eInvoice = default(bool?), string eiCode = default(string), bool? discountHighlight = default(bool?), decimal? defaultDiscount = default(decimal?), bool? hasIntentDeclaration = default(bool?), DateTime? intentDeclarationProtocolNumber = default(DateTime?), string intentDeclarationProtocolDate = default(string), string createdAt = default(string), string updatedAt = default(string))
        {
            ...
            if (this.ContactPerson != null) this._flagContactPerson = true;
            this._VatNumber = vatNumber;
            if (this.VatNumber != null) this._flagVatNumber = true;
            this._TaxCode = taxCode;
            if (this.TaxCode != null) this._flagTaxCode = true;
            this._AddressStreet = addressStreet;
            if (this.AddressStreet != null) this._flagAddressStreet = true;
            this._AddressPostalCode = addressPostalCode;
            if (this.AddressPostalCode != null) this._flagAddressPostalCode = true;
            this._AddressCity = addressCity;
            if (this.AddressCity != null) this._flagAddressCity = true;
            this._AddressProvince = addressProvince;
            if (this.AddressProvince != null) this._flagAddressProvince = true;
            this._AddressExtra = addressExtra;
            if (this.AddressExtra != null) this._flagAddressExtra = true;
            this._Country = country;
            if (this.Country != null) this._flagCountry = true;
            this._Email = email;
            if (this.Email != null) this._flagEmail = true;
            this._CertifiedEmail = certifiedEmail;
            if (this.CertifiedEmail != null) this._flagCertifiedEmail = true;
            this._Phone = phone;
            if (this.Phone != null) this._flagPhone = true;
            this._Fax = fax;
            if (this.Fax != null) this._flagFax = true;
            this._Notes = notes;
            if (this.Notes != null) this._flagNotes = true;
            this._DefaultVat = defaultVat;
            if (this.DefaultVat != null) this._flagDefaultVat = true;
            this._DefaultPaymentTerms = defaultPaymentTerms;
            if (this.DefaultPaymentTerms != null) this._flagDefaultPaymentTerms = true;
            this._DefaultPaymentTermsType = defaultPaymentTermsType;
            if (this.DefaultPaymentTermsType != null) this._flagDefaultPaymentTermsType = true;
            this._DefaultPaymentMethod = defaultPaymentMethod;
            if (this.DefaultPaymentMethod != null) this._flagDefaultPaymentMethod = true;
            ...
            if (this.BankSwiftCode != null) this._flagBankSwiftCode = true;
            this._ShippingAddress = shippingAddress;
            if (this.ShippingAddress != null) this._flagShippingAddress = true;
            this._EInvoice = eInvoice;
            if (this.EInvoice != null) this._flagEInvoice = true;
            this._EiCode = eiCode;
            if (this.EiCode != null) this._flagEiCode = true;
            ...
            if (this.DefaultDiscount != null) this._flagDefaultDiscount = true;
            this._HasIntentDeclaration = hasIntentDeclaration;
            if (this.HasIntentDeclaration != null) this._flagHasIntentDeclaration = true;
            this._IntentDeclarationProtocolNumber = intentDeclarationProtocolNumber;
            if (this.IntentDeclarationProtocolNumber != null) this._flagIntentDeclarationProtocolNumber = true;
            this._IntentDeclarationProtocolDate = intentDeclarationProtocolDate;
            if (this.IntentDeclarationProtocolDate != null) this._flagIntentDeclarationProtocolDate = true;
            this._CreatedAt = createdAt;
            if (this.CreatedAt != null) this._flagCreatedAt = true;
            this._UpdatedAt = updatedAt;
            if (this.UpdatedAt != null) this._flagUpdatedAt = true;
        }
        ...
        /// </summary>
        /// <value>Intent declaration protocol number.</value>
        ...
        /// </summary>
        /// <value>Intent declaration protocol date.</value>
        ...
        public bool Equals(ModelClient input)
        {
            ...
            return
                ...
                (
                    ...
                    (this.HasIntentDeclaration != null &&
                ...
                (
                    ...
                    (this.IntentDeclarationProtocolDate != null &&
