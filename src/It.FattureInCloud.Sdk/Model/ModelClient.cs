...
namespace It.FattureInCloud.Sdk.Model
{
    ...
    public class ModelClient : IEquatable<ModelClient>, IValidatableObject
    {
        ...
        public ModelClient(int? id = default(int?), string code = default(string), string name = default(string),
            ClientType? type = default(ClientType?), string firstName = default(string),
            ...
            bool? discountHighlight = default(bool?), decimal? defaultDiscount = default(decimal?),
            ...
            string updatedAt = default(string))
        {
            ...
            if (DefaultDiscount != null) _flagDefaultDiscount = true;
            ...
            return
                ...
                (
                    ...
                    (DefaultDiscount != null &&
                     DefaultDiscount.Equals(input.DefaultDiscount))
                ) &&
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (DefaultDiscount != null) hashCode = hashCode * 59 + DefaultDiscount.GetHashCode();
