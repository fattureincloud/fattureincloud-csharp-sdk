...
namespace It.FattureInCloud.Sdk.Model
{
    ...
    public partial class ListF24Response : IEquatable<ListF24Response>, IValidatableObject
    {
        ...
        public ListF24Response(int? currentPage = default(int?), string firstPageUrl = default(string), int? from = default(int?), int? lastPage = default(int?), string lastPageUrl = default(string), string nextPageUrl = default(string), string path = default(string), int? perPage = default(int?), string prevPageUrl = default(string), int? to = default(int?), int? total = default(int?), List<F24> data = default(List<F24>), ListF24ResponseAggregatedData aggregatedData = default(ListF24ResponseAggregatedData))
        {
            this._CurrentPage = currentPage;
            if (this.CurrentPage != null) this._flagCurrentPage = true;
            this._FirstPageUrl = firstPageUrl;
            if (this.FirstPageUrl != null) this._flagFirstPageUrl = true;
            this._From = from;
            if (this.From != null) this._flagFrom = true;
            this._LastPage = lastPage;
            if (this.LastPage != null) this._flagLastPage = true;
            this._LastPageUrl = lastPageUrl;
            if (this.LastPageUrl != null) this._flagLastPageUrl = true;
            this._NextPageUrl = nextPageUrl;
            if (this.NextPageUrl != null) this._flagNextPageUrl = true;
            this._Path = path;
            if (this.Path != null) this._flagPath = true;
            this._PerPage = perPage;
            if (this.PerPage != null) this._flagPerPage = true;
            this._PrevPageUrl = prevPageUrl;
            if (this.PrevPageUrl != null) this._flagPrevPageUrl = true;
            this._To = to;
            if (this.To != null) this._flagTo = true;
            this._Total = total;
            if (this.Total != null) this._flagTotal = true;
            this._Data = data;
            if (this.Data != null) this._flagData = true;
            this._AggregatedData = aggregatedData;
            if (this.AggregatedData != null) this._flagAggregatedData = true;
        }
