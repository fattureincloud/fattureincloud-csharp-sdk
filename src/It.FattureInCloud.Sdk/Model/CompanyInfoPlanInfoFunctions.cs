...
namespace It.FattureInCloud.Sdk.Model
{
    ...
    public class CompanyInfoPlanInfoFunctionsJsonConverter : JsonConverter<CompanyInfoPlanInfoFunctions>
    {
        ...
        public override CompanyInfoPlanInfoFunctions Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
                    ...
                    switch (localVarJsonPropertyName)
                    {
                        case "archive":
                            if (utf8JsonReader.TokenType != JsonTokenType.Null)
                                archive = new Option<bool?>(utf8JsonReader.GetBoolean());
                            break;
                        case "cerved":
                            if (utf8JsonReader.TokenType != JsonTokenType.Null)
                                cerved = new Option<bool?>(utf8JsonReader.GetBoolean());
                            break;
                        case "document_attachments":
                            if (utf8JsonReader.TokenType != JsonTokenType.Null)
                                documentAttachments = new Option<bool?>(utf8JsonReader.GetBoolean());
                            break;
                        case "e_invoice":
                            if (utf8JsonReader.TokenType != JsonTokenType.Null)
                        ...
                        case "genius":
                            if (utf8JsonReader.TokenType != JsonTokenType.Null)
                                genius = new Option<bool?>(utf8JsonReader.GetBoolean());
                            break;
                        case "mail_tracking":
                            if (utf8JsonReader.TokenType != JsonTokenType.Null)
                                mailTracking = new Option<bool?>(utf8JsonReader.GetBoolean());
                            break;
                        case "payment_notifications":
                            if (utf8JsonReader.TokenType != JsonTokenType.Null)
                                paymentNotifications = new Option<bool?>(utf8JsonReader.GetBoolean());
                            break;
                        case "paypal":
                            if (utf8JsonReader.TokenType != JsonTokenType.Null)
                                paypal = new Option<bool?>(utf8JsonReader.GetBoolean());
                            break;
                        case "receipts":
                            if (utf8JsonReader.TokenType != JsonTokenType.Null)
                                receipts = new Option<bool?>(utf8JsonReader.GetBoolean());
                            break;
                        case "recurring":
                            if (utf8JsonReader.TokenType != JsonTokenType.Null)
                                recurring = new Option<bool?>(utf8JsonReader.GetBoolean());
                            break;
                        case "smtp":
                            if (utf8JsonReader.TokenType != JsonTokenType.Null)
                                smtp = new Option<bool?>(utf8JsonReader.GetBoolean());
                            break;
                        case "sofort":
                            if (utf8JsonReader.TokenType != JsonTokenType.Null)
                                sofort = new Option<bool?>(utf8JsonReader.GetBoolean());
                            break;
                        case "stock":
                            if (utf8JsonReader.TokenType != JsonTokenType.Null)
                                stock = new Option<bool?>(utf8JsonReader.GetBoolean());
                            break;
                        case "subaccounts":
                            if (utf8JsonReader.TokenType != JsonTokenType.Null)
                                subaccounts = new Option<bool?>(utf8JsonReader.GetBoolean());
                            break;
                        case "tessera_sanitaria":
                            if (utf8JsonReader.TokenType != JsonTokenType.Null)
                                tesseraSanitaria = new Option<bool?>(utf8JsonReader.GetBoolean());
                            break;
                        case "ts_digital":
                            if (utf8JsonReader.TokenType != JsonTokenType.Null)
                                tsDigital = new Option<bool?>(utf8JsonReader.GetBoolean());
                            break;
                        case "ts_invoice_trading":
                            if (utf8JsonReader.TokenType != JsonTokenType.Null)
                                tsInvoiceTrading = new Option<bool?>(utf8JsonReader.GetBoolean());
                            break;
                        case "ts_pay":
                            if (utf8JsonReader.TokenType != JsonTokenType.Null)
                                tsPay = new Option<bool?>(utf8JsonReader.GetBoolean());
                            break;
                        default:
                            break;
                    }
            ...
            return new CompanyInfoPlanInfoFunctions(archive, cerved, documentAttachments, eInvoice, genius, mailTracking, paymentNotifications, paypal, receipts, recurring, smtp, sofort, stock, subaccounts, tesseraSanitaria, tsDigital, tsInvoiceTrading, tsPay);
        }
        ...
        public void WriteProperties(Utf8JsonWriter writer, CompanyInfoPlanInfoFunctions companyInfoPlanInfoFunctions, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (companyInfoPlanInfoFunctions.SofortOption.IsSet)
                if (companyInfoPlanInfoFunctions.SofortOption.Value != null)
                    writer.WriteBoolean("sofort", companyInfoPlanInfoFunctions.SofortOption.Value.Value);
                else
                    writer.WriteNull("sofort");
