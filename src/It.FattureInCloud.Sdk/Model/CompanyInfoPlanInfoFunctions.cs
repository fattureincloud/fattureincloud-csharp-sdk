...
namespace It.FattureInCloud.Sdk.Model
{
    ...
    public partial class CompanyInfoPlanInfoFunctions : IEquatable<CompanyInfoPlanInfoFunctions>, IValidatableObject
    {
        ...
        public CompanyInfoPlanInfoFunctions(bool? archive = default(bool?), bool? cerved = default(bool?), bool? documentAttachments = default(bool?), bool? eInvoice = default(bool?), bool? genius = default(bool?), bool? mailTracking = default(bool?), bool? paymentNotifications = default(bool?), bool? paypal = default(bool?), bool? receipts = default(bool?), bool? recurring = default(bool?), bool? smtp = default(bool?), bool? sofort = default(bool?), bool? stock = default(bool?), bool? subaccounts = default(bool?), bool? tesseraSanitaria = default(bool?), bool? tsDigital = default(bool?), bool? tsInvoiceTrading = default(bool?), bool? tsPay = default(bool?))
        {
            ...
            if (this.Archive != null) this._flagArchive = true;
            this._Cerved = cerved;
            if (this.Cerved != null) this._flagCerved = true;
            this._DocumentAttachments = documentAttachments;
            if (this.DocumentAttachments != null) this._flagDocumentAttachments = true;
            this._EInvoice = eInvoice;
            if (this.EInvoice != null) this._flagEInvoice = true;
            this._Genius = genius;
            if (this.Genius != null) this._flagGenius = true;
            this._MailTracking = mailTracking;
            if (this.MailTracking != null) this._flagMailTracking = true;
            this._PaymentNotifications = paymentNotifications;
            if (this.PaymentNotifications != null) this._flagPaymentNotifications = true;
            this._Paypal = paypal;
            if (this.Paypal != null) this._flagPaypal = true;
            this._Receipts = receipts;
            if (this.Receipts != null) this._flagReceipts = true;
            this._Recurring = recurring;
            if (this.Recurring != null) this._flagRecurring = true;
            this._Smtp = smtp;
            if (this.Smtp != null) this._flagSmtp = true;
            this._Sofort = sofort;
            if (this.Sofort != null) this._flagSofort = true;
            this._Stock = stock;
            if (this.Stock != null) this._flagStock = true;
            this._Subaccounts = subaccounts;
            if (this.Subaccounts != null) this._flagSubaccounts = true;
            this._TesseraSanitaria = tesseraSanitaria;
            if (this.TesseraSanitaria != null) this._flagTesseraSanitaria = true;
            this._TsDigital = tsDigital;
            if (this.TsDigital != null) this._flagTsDigital = true;
            this._TsInvoiceTrading = tsInvoiceTrading;
            if (this.TsInvoiceTrading != null) this._flagTsInvoiceTrading = true;
            this._TsPay = tsPay;
            if (this.TsPay != null) this._flagTsPay = true;
        }
