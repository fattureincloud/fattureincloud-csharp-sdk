                    ...
                    switch (localVarJsonPropertyName)
                    {
                        case "clients":
                            if (utf8JsonReader.TokenType != JsonTokenType.Null)
                                clients = new Option<int?>(utf8JsonReader.GetInt32());
                            break;
                        case "suppliers":
                            if (utf8JsonReader.TokenType != JsonTokenType.Null)
                                suppliers = new Option<int?>(utf8JsonReader.GetInt32());
                            break;
                        case "products":
                            if (utf8JsonReader.TokenType != JsonTokenType.Null)
                                products = new Option<int?>(utf8JsonReader.GetInt32());
                            break;
                        case "documents":
                            if (utf8JsonReader.TokenType != JsonTokenType.Null)
                                documents = new Option<int?>(utf8JsonReader.GetInt32());
                            break;
                        default:
                            break;
                    }
