...
namespace It.FattureInCloud.Sdk.Model
{
    ...
    public class ListClientsResponse : IEquatable<ListClientsResponse>, IValidatableObject
    {
        ...
        public ListClientsResponse(int? currentPage = default(int?), string firstPageUrl = default(string),
            ...
            List<ModelClient> data = default(List<ModelClient>))
        {
        ...
        {
            return Equals(input as ListClientsResponse);
        }
