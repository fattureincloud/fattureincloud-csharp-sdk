...
namespace It.FattureInCloud.Sdk.Model
{
    ...
    public partial class CompanyInfoAccessInfo : IEquatable<CompanyInfoAccessInfo>, IValidatableObject
    {
        ...
        /// </summary>
        /// <param name="role">Role of the user in this company..</param>
        /// <param name="permissions">permissions.</param>
        /// <param name="throughAccountant">throughAccountant.</param>
        public CompanyInfoAccessInfo(RoleEnum? role = default(RoleEnum?), Permissions permissions = default(Permissions), bool throughAccountant = default(bool))
        {
            this.Role = role;
