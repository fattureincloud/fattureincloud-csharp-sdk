...
namespace It.FattureInCloud.Sdk.Model
{
    ...
    public partial class PriceList : IEquatable<PriceList>, IValidatableObject
    {
        ...
        public PriceList(string id = default(string), string name = default(string), PriceListPricesType? pricesType = default(PriceListPricesType?), bool isDefault = default(bool), string validFrom = default(string), string validTo = default(string), PriceListType? type = default(PriceListType?))
        {
            this._Id = id;
            if (this.Id != null)
            {
