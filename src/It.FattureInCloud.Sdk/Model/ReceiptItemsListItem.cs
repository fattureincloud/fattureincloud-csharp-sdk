...
namespace It.FattureInCloud.Sdk.Model
{
    ...
    public partial class ReceiptItemsListItem : IEquatable<ReceiptItemsListItem>, IValidatableObject
    {
        ...
        public ReceiptItemsListItem(decimal id = default(decimal), decimal amountNet = default(decimal), decimal amountGross = default(decimal), string category = default(string), VatType vat = default(VatType))
        {
            this.Id = id;
