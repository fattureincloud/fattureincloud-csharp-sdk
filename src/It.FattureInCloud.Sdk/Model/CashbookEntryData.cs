...
namespace It.FattureInCloud.Sdk.Model
{
    ...
    public partial class CashbookEntryData : IEquatable<CashbookEntryData>, IValidatableObject
    {
        ...
        public CashbookEntryData(string id = default(string), DateTimeOffset date = default(DateTimeOffset), string description = default(string), CashbookEntryKind? kind = default(CashbookEntryKind?), CashbookEntryType? type = default(CashbookEntryType?), string entityName = default(string), CashbookEntryDataDocument document = default(CashbookEntryDataDocument))
        {
            this.Id = id;
            this.Date = date;
