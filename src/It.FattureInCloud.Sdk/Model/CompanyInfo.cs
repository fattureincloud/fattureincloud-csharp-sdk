...
namespace It.FattureInCloud.Sdk.Model
{
    ...
    public partial class CompanyInfo : IEquatable<CompanyInfo>, IValidatableObject
    {
        ...
        public CompanyInfo(int id = default, string name = default, string email = default, CompanyType? type = default, CompanyInfoAccessInfo accessInfo = default, DateTimeOffset ficLicenseExpire = default, FattureInCloudPlanType? ficPlanName = default, CompanyInfoPlanInfo planInfo = default, int accountantId = default, bool isAccountant = default)
        {
            this._Id = id;
            if (this.Id != null)
            {
