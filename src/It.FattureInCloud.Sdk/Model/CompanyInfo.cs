...
namespace It.FattureInCloud.Sdk.Model
{
    ...
    public partial class CompanyInfo : IEquatable<CompanyInfo>, IValidatableObject
    {
        ...
        public CompanyInfo(int id = default(int), string name = default(string), string email = default(string), CompanyType? type = default(CompanyType?), CompanyInfoAccessInfo accessInfo = default(CompanyInfoAccessInfo), DateTimeOffset ficLicenseExpire = default(DateTimeOffset), FattureInCloudPlanType? ficPlanName = default(FattureInCloudPlanType?), CompanyInfoPlanInfo planInfo = default(CompanyInfoPlanInfo), int accountantId = default(int), bool isAccountant = default(bool))
        {
            this._Id = id;
            if (this.Id != null)
            {
        ...
        public DateTimeOffset FicLicenseExpire
        {
        ...
        private DateTimeOffset _FicLicenseExpire;
            ...
            while (utf8JsonReader.Read())
            {
                ...
                if (utf8JsonReader.TokenType == JsonTokenType.PropertyName && currentDepth == utf8JsonReader.CurrentDepth - 1)
                {
                    ...
                    switch (localVarJsonPropertyName)
                    {
                        ...
                        case "accountant_id":
                            if (utf8JsonReader.TokenType != JsonTokenType.Null)
                                accountantId = new Option<int?>(utf8JsonReader.GetInt32());
                            break;
                        case "is_accountant":
                            if (utf8JsonReader.TokenType != JsonTokenType.Null)
                                isAccountant = new Option<bool?>(utf8JsonReader.GetBoolean());
                            break;
                        default:
                            break;
                    }
