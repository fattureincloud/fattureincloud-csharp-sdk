                ...
                if (utf8JsonReader.TokenType == JsonTokenType.PropertyName && currentDepth == utf8JsonReader.CurrentDepth - 1)
                {
                    ...
                    switch (localVarJsonPropertyName)
                    {
                        ...
                        case "document_exists":
                            if (utf8JsonReader.TokenType != JsonTokenType.Null)
                                documentExists = new Option<bool?>(utf8JsonReader.GetBoolean());
                            break;
                        case "delivery_note_exists":
                            if (utf8JsonReader.TokenType != JsonTokenType.Null)
                                deliveryNoteExists = new Option<bool?>(utf8JsonReader.GetBoolean());
                            break;
                        case "attachment_exists":
                            if (utf8JsonReader.TokenType != JsonTokenType.Null)
                                attachmentExists = new Option<bool?>(utf8JsonReader.GetBoolean());
                            break;
                        case "accompanying_invoice_exists":
                            if (utf8JsonReader.TokenType != JsonTokenType.Null)
                                accompanyingInvoiceExists = new Option<bool?>(utf8JsonReader.GetBoolean());
                            break;
                        case "default_attach_pdf":
                            if (utf8JsonReader.TokenType != JsonTokenType.Null)
                                defaultAttachPdf = new Option<bool?>(utf8JsonReader.GetBoolean());
                            break;
                        default:
                            break;
                    }
