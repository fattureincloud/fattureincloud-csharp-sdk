...
namespace It.FattureInCloud.Sdk.Model
{
    ...
    public partial class EmailData : IEquatable<EmailData>, IValidatableObject
    {
        ...
        public EmailData(string recipientEmail = default(string), EmailDataDefaultSenderEmail defaultSenderEmail = default(EmailDataDefaultSenderEmail), List<EmailDataSenderEmailsList> senderEmailsList = default(List<EmailDataSenderEmailsList>), string ccEmail = default(string), string subject = default(string), string body = default(string), bool documentExists = default(bool), bool deliveryNoteExists = default(bool), bool attachmentExists = default(bool), bool accompanyingInvoiceExists = default(bool), bool defaultAttachPdf = default(bool))
        {
        ...
        public List<EmailDataSenderEmailsList> SenderEmailsList { get; set; }
