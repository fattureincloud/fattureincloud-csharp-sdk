...
namespace It.FattureInCloud.Sdk.Model
{
    ...
    public class CreateReceivedDocumentRequest : IEquatable<CreateReceivedDocumentRequest>, IValidatableObject
    {
        ...
        public CreateReceivedDocumentRequest(int? pendingId = default(int?), ReceivedDocument data = default)
        {
            _PendingId = pendingId;
            if (PendingId != null) _flagPendingId = true;
            _Data = data;
        ...
        {
            return Equals(input as CreateReceivedDocumentRequest);
        }
        ...
        public bool Equals(CreateReceivedDocumentRequest input)
        {
            ...
            return
                (
                    ...
                    (PendingId != null &&
                     PendingId.Equals(input.PendingId))
                ) &&
                (
                    Data == input.Data ||
                    (Data != null &&
        ...
        public override int GetHashCode()
        {
            ...
            {
                int hashCode = 41;
                if (PendingId != null) hashCode = hashCode * 59 + PendingId.GetHashCode();
