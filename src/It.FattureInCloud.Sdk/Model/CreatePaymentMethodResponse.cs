...
namespace It.FattureInCloud.Sdk.Model
{
    ...
    /// </summary>
    public partial class CreatePaymentMethodResponse : IValidatableObject
    {
        /// <summary>
        ...
        [JsonConstructor]
        public CreatePaymentMethodResponse(Option<PaymentMethod> data = default)
        {
            DataOption = data;
            OnCreated();
        }
        ...
        public Option<PaymentMethod> DataOption { get; private set; }

        /// <summary>
        /// Gets or Sets Data
        /// </summary>
        [JsonPropertyName("data")]
        public PaymentMethod Data { get { return this.DataOption; } set { this.DataOption = new Option<PaymentMethod>(value); } }
