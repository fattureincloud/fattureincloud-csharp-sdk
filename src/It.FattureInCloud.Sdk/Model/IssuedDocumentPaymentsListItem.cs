...
namespace It.FattureInCloud.Sdk.Model
{
    ...
    public partial class IssuedDocumentPaymentsListItem : IEquatable<IssuedDocumentPaymentsListItem>, IValidatableObject
    {
        ...
        public IssuedDocumentPaymentsListItem(int id = default, DateTimeOffset dueDate = default, decimal amount = default, IssuedDocumentStatus? status = default, PaymentAccount paymentAccount = default, DateTimeOffset paidDate = default, Object eiRaw = default, IssuedDocumentPaymentsListItemPaymentTerms paymentTerms = default)
        {
            this._Id = id;
            if (this.Id != null)
            {
        ...
        */
        ...
        private DateTimeOffset _PaidDate;
