...
namespace It.FattureInCloud.Sdk.Model
{
    ...
    public partial class IssuedDocumentPaymentsListItem : IEquatable<IssuedDocumentPaymentsListItem>, IValidatableObject
    {
        ...
        public IssuedDocumentPaymentsListItem(int id = default(int), DateTimeOffset dueDate = default(DateTimeOffset), decimal amount = default(decimal), IssuedDocumentStatus? status = default(IssuedDocumentStatus?), PaymentAccount paymentAccount = default(PaymentAccount), DateTimeOffset paidDate = default(DateTimeOffset), Object eiRaw = default(Object), IssuedDocumentPaymentsListItemPaymentTerms paymentTerms = default(IssuedDocumentPaymentsListItemPaymentTerms))
        {
            this._Id = id;
            if (this.Id != null)
            {
