...
namespace It.FattureInCloud.Sdk.Model
{
    ...
    public partial class PaymentAccount : IEquatable<PaymentAccount>, IValidatableObject
    {
        ...
        public PaymentAccount(int? id = default(int?), string name = default(string), PaymentAccountType? type = default(PaymentAccountType?), string iban = default(string), string sia = default(string), string cuc = default(string), bool? varVirtual = default(bool?))
        {
            this._Id = id;
            if (this.Id != null)
            {
            ...
            this._VarVirtual = varVirtual;
            if (this.VarVirtual != null)
            {
                this._flagVarVirtual = true;
            }
        }
        ...
        public bool? VarVirtual
        {
            get { return _VarVirtual; }
            set
            {
                _VarVirtual = value;
                _flagVarVirtual = true;
            }
        }
        private bool? _VarVirtual;
        private bool _flagVarVirtual;

        /// <summary>
        /// Returns false as VarVirtual should not be serialized given that it's read-only.
        /// </summary>
        /// <returns>false (boolean)</returns>
        public bool ShouldSerializeVarVirtual()
        {
            return _flagVarVirtual;
        }
        /// <summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("  VarVirtual: ").Append(VarVirtual).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        public bool Equals(PaymentAccount input)
        {
            ...
            return
                ...
                (
                    this.VarVirtual == input.VarVirtual ||
                    (this.VarVirtual != null &&
                    this.VarVirtual.Equals(input.VarVirtual))
                );
        }
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.VarVirtual != null)
                {
                    hashCode = (hashCode * 59) + this.VarVirtual.GetHashCode();
                }
                return hashCode;
            }
        }
