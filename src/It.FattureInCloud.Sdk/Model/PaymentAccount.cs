...
namespace It.FattureInCloud.Sdk.Model
{
    ...
    public partial class PaymentAccount : IEquatable<PaymentAccount>, IValidatableObject
    {
        ...
        /// <param name="type">Payment account type. (default to TypeEnum.Standard).</param>
        ...
        public PaymentAccount(int id = default(int), string name = default(string), TypeEnum? type = TypeEnum.Standard, string iban = default(string), string sia = default(string), string cuc = default(string), bool _virtual = default(bool))
        {
            this.Id = id;
            this.Name = name;
            this.Type = type;
