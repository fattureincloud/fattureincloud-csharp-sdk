...
namespace It.FattureInCloud.Sdk.Model
{
    ...
    public partial class IssuedDocumentEiData : IEquatable<IssuedDocumentEiData>, IValidatableObject
    {
        ...
        public IssuedDocumentEiData(VatKind? vatKind = default, OriginalDocumentType? originalDocumentType = default, string odNumber = default, DateTime? odDate = default, string cig = default, string cup = default, string paymentMethod = default, string bankName = default, string bankIban = default, string bankBeneficiary = default, string invoiceNumber = default, DateTime? invoiceDate = default)
        {
