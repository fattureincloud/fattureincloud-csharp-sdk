...
namespace It.FattureInCloud.Sdk.Model
{
    ...
    public class ControlledCompany : IEquatable<ControlledCompany>, IValidatableObject
    {
        ...
        public ControlledCompany(int? id = default(int?), string name = default(string),
            CompanyType? type = default(CompanyType?), string accessToken = default(string),
            decimal? connectionId = default(decimal?), string taxCode = default(string))
        {
            _Id = id;
        ...
        {
            return Equals(input as ControlledCompany);
        }
