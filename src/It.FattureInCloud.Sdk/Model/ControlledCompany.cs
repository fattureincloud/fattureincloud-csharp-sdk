...
namespace It.FattureInCloud.Sdk.Model
{
    ...
    public partial class ControlledCompany : IEquatable<ControlledCompany>, IValidatableObject
    {
        ...
        public ControlledCompany(int? id = default, string name = default, CompanyType? type = default, string accessToken = default, DateTime? ficLicenseExpire = default, FattureInCloudPlanType? ficPlan = default, decimal? connectionId = default, string taxCode = default)
        {
            this._Id = id;
            if (this.Id != null)
            {
