...
namespace It.FattureInCloud.Sdk.Model
{
    ...
    public partial class ControlledCompany : IEquatable<ControlledCompany>, IValidatableObject
    {
        ...
        public ControlledCompany(int id = default(int), string name = default(string), CompanyType? type = default(CompanyType?), string accessToken = default(string), DateTimeOffset ficLicenseExpire = default(DateTimeOffset), FattureInCloudPlanType? ficPlan = default(FattureInCloudPlanType?), decimal connectionId = default(decimal), string taxCode = default(string))
        {
            this._Id = id;
            if (this.Id != null)
            {
            ...
            while (utf8JsonReader.Read())
            {
                ...
                if (utf8JsonReader.TokenType == JsonTokenType.PropertyName && currentDepth == utf8JsonReader.CurrentDepth - 1)
                {
                    ...
                    switch (localVarJsonPropertyName)
                    {
                        ...
                        case "connection_id":
                            if (utf8JsonReader.TokenType != JsonTokenType.Null)
                                connectionId = new Option<decimal?>(utf8JsonReader.GetDecimal());
                            break;
                        case "tax_code":
