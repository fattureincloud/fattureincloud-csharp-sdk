                ...
                if (utf8JsonReader.TokenType == JsonTokenType.PropertyName && currentDepth == utf8JsonReader.CurrentDepth - 1)
                {
                    ...
                    switch (localVarJsonPropertyName)
                    {
                        ...
                        case "amount_net_with_rivalsa":
                            if (utf8JsonReader.TokenType != JsonTokenType.Null)
                                amountNetWithRivalsa = new Option<decimal?>(utf8JsonReader.GetDecimal());
                            break;
                        case "amount_cassa":
                            if (utf8JsonReader.TokenType != JsonTokenType.Null)
                        ...
                        case "taxable_amount":
                            if (utf8JsonReader.TokenType != JsonTokenType.Null)
                                taxableAmount = new Option<decimal?>(utf8JsonReader.GetDecimal());
                            break;
                        case "not_taxable_amount":
                            if (utf8JsonReader.TokenType != JsonTokenType.Null)
                                notTaxableAmount = new Option<decimal?>(utf8JsonReader.GetDecimal());
                            break;
                        case "amount_vat":
                            if (utf8JsonReader.TokenType != JsonTokenType.Null)
                        ...
                        case "taxable_amount_withholding_tax":
                            if (utf8JsonReader.TokenType != JsonTokenType.Null)
                                taxableAmountWithholdingTax = new Option<decimal?>(utf8JsonReader.GetDecimal());
                            break;
                        ...
                        case "taxable_amount_other_withholding_tax":
                            if (utf8JsonReader.TokenType != JsonTokenType.Null)
                                taxableAmountOtherWithholdingTax = new Option<decimal?>(utf8JsonReader.GetDecimal());
                            break;
                        ...
                        case "amount_due":
                            if (utf8JsonReader.TokenType != JsonTokenType.Null)
                                amountDue = new Option<decimal?>(utf8JsonReader.GetDecimal());
                            break;
                        case "is_enasarco_maximal_exceeded":
                            if (utf8JsonReader.TokenType != JsonTokenType.Null)
                                isEnasarcoMaximalExceeded = new Option<bool?>(utf8JsonReader.GetBoolean());
                            break;
                        case "payments_sum":
                            if (utf8JsonReader.TokenType != JsonTokenType.Null)
                                paymentsSum = new Option<decimal?>(utf8JsonReader.GetDecimal());
                            break;
                        case "vat_list":
                            if (utf8JsonReader.TokenType != JsonTokenType.Null)
