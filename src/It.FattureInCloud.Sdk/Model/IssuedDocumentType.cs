...
namespace It.FattureInCloud.Sdk.Model
{
    ...
    public enum IssuedDocumentType
    {
        ...
        /// </summary>
        [EnumMember(Value = "quote")] Quote = 2,

        /// <summary>
        ///     Enum Proforma for value: proforma
        /// </summary>
        [EnumMember(Value = "proforma")] Proforma = 3,

        /// <summary>
        ///     Enum Receipt for value: receipt
        /// </summary>
        [EnumMember(Value = "receipt")] Receipt = 4,

        /// <summary>
        ///     Enum DeliveryNote for value: delivery_note
        /// </summary>
        [EnumMember(Value = "delivery_note")] DeliveryNote = 5,

        /// <summary>
        ///     Enum CreditNote for value: credit_note
        /// </summary>
        [EnumMember(Value = "credit_note")] CreditNote = 6,

        /// <summary>
        ///     Enum Order for value: order
        /// </summary>
        [EnumMember(Value = "order")] Order = 7,

        /// <summary>
        ///     Enum WorkReport for value: work_report
        /// </summary>
        [EnumMember(Value = "work_report")] WorkReport = 8,

        /// <summary>
        ///     Enum SupplierOrder for value: supplier_order
        /// </summary>
        [EnumMember(Value = "supplier_order")] SupplierOrder = 9
    }
}