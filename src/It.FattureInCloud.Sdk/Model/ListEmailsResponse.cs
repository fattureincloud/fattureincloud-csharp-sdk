...
namespace It.FattureInCloud.Sdk.Model
{
    ...
    public partial class ListEmailsResponse : IEquatable<ListEmailsResponse>, IValidatableObject
    {
        ...
        public ListEmailsResponse(int currentPage = default(int), string firstPageUrl = default(string), int from = default(int), int lastPage = default(int), string lastPageUrl = default(string), string nextPageUrl = default(string), string path = default(string), int perPage = default(int), string prevPageUrl = default(string), int to = default(int), int total = default(int), List<Email> data = default(List<Email>))
        {
