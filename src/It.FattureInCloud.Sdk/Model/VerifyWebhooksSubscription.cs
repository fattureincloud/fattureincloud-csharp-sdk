...
namespace It.FattureInCloud.Sdk.Model
{
    ...
    public partial class VerifyWebhooksSubscription : IEquatable<VerifyWebhooksSubscription>, IValidatableObject
    {
        ...
        public VerifyWebhooksSubscription(string id = default(string), WebhooksSubscriptionVerificationMethod? verificationMethod = default(WebhooksSubscriptionVerificationMethod?))
        {
            this._Id = id;
            if (this.Id != null)
            {
