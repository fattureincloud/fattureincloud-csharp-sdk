...
namespace It.FattureInCloud.Sdk.Model
{
    ...
    public partial class IssuedDocument : IEquatable<IssuedDocument>, IValidatableObject
    {
        ...
        private DateTimeOffset _DnDate;
        ...
        private DateTimeOffset _SeenDate;
        ...
        private DateTimeOffset _NextDueDate;
            ...
            while (utf8JsonReader.Read())
            {
                ...
                if (utf8JsonReader.TokenType == JsonTokenType.PropertyName && currentDepth == utf8JsonReader.CurrentDepth - 1)
                {
                    ...
                    switch (localVarJsonPropertyName)
                    {
                        ...
                        case "rivalsa":
                            if (utf8JsonReader.TokenType != JsonTokenType.Null)
                                rivalsa = new Option<decimal?>(utf8JsonReader.GetDecimal());
                            break;
                        case "cassa":
                            if (utf8JsonReader.TokenType != JsonTokenType.Null)
                                cassa = new Option<decimal?>(utf8JsonReader.GetDecimal());
                            break;
                        case "amount_cassa":
                            if (utf8JsonReader.TokenType != JsonTokenType.Null)
                                amountCassa = new Option<decimal?>(utf8JsonReader.GetDecimal());
                            break;
                        case "cassa_taxable":
                            if (utf8JsonReader.TokenType != JsonTokenType.Null)
                                cassaTaxable = new Option<decimal?>(utf8JsonReader.GetDecimal());
                            break;
                        case "amount_cassa_taxable":
                            if (utf8JsonReader.TokenType != JsonTokenType.Null)
                                amountCassaTaxable = new Option<decimal?>(utf8JsonReader.GetDecimal());
                            break;
                        case "cassa2":
                            if (utf8JsonReader.TokenType != JsonTokenType.Null)
                                cassa2 = new Option<decimal?>(utf8JsonReader.GetDecimal());
                            break;
                        case "amount_cassa2":
                            if (utf8JsonReader.TokenType != JsonTokenType.Null)
                                amountCassa2 = new Option<decimal?>(utf8JsonReader.GetDecimal());
                            break;
                        case "cassa2_taxable":
                            if (utf8JsonReader.TokenType != JsonTokenType.Null)
                                cassa2Taxable = new Option<decimal?>(utf8JsonReader.GetDecimal());
                            break;
                        case "amount_cassa2_taxable":
                            if (utf8JsonReader.TokenType != JsonTokenType.Null)
                                amountCassa2Taxable = new Option<decimal?>(utf8JsonReader.GetDecimal());
                            break;
                        case "global_cassa_taxable":
                            if (utf8JsonReader.TokenType != JsonTokenType.Null)
                                globalCassaTaxable = new Option<decimal?>(utf8JsonReader.GetDecimal());
                            break;
                        case "amount_global_cassa_taxable":
                            if (utf8JsonReader.TokenType != JsonTokenType.Null)
                                amountGlobalCassaTaxable = new Option<decimal?>(utf8JsonReader.GetDecimal());
                            break;
                        case "withholding_tax":
                            if (utf8JsonReader.TokenType != JsonTokenType.Null)
                                withholdingTax = new Option<decimal?>(utf8JsonReader.GetDecimal());
                            break;
                        case "withholding_tax_taxable":
                            if (utf8JsonReader.TokenType != JsonTokenType.Null)
                                withholdingTaxTaxable = new Option<decimal?>(utf8JsonReader.GetDecimal());
                            break;
                        case "other_withholding_tax":
                            if (utf8JsonReader.TokenType != JsonTokenType.Null)
                                otherWithholdingTax = new Option<decimal?>(utf8JsonReader.GetDecimal());
                            break;
                        case "stamp_duty":
                            if (utf8JsonReader.TokenType != JsonTokenType.Null)
                                stampDuty = new Option<decimal?>(utf8JsonReader.GetDecimal());
                            break;
                        case "payment_method":
                            if (utf8JsonReader.TokenType != JsonTokenType.Null)
                        ...
                        case "use_split_payment":
                            if (utf8JsonReader.TokenType != JsonTokenType.Null)
                                useSplitPayment = new Option<bool?>(utf8JsonReader.GetBoolean());
                            break;
                        case "use_gross_prices":
                            if (utf8JsonReader.TokenType != JsonTokenType.Null)
                                useGrossPrices = new Option<bool?>(utf8JsonReader.GetBoolean());
                            break;
                        case "e_invoice":
                            if (utf8JsonReader.TokenType != JsonTokenType.Null)
                                eInvoice = new Option<bool?>(utf8JsonReader.GetBoolean());
                            break;
                        case "ei_data":
                            if (utf8JsonReader.TokenType != JsonTokenType.Null)
                        ...
                        case "h_margins":
                            if (utf8JsonReader.TokenType != JsonTokenType.Null)
                                hMargins = new Option<int?>(utf8JsonReader.GetInt32());
                            break;
                        case "v_margins":
                            if (utf8JsonReader.TokenType != JsonTokenType.Null)
                                vMargins = new Option<int?>(utf8JsonReader.GetInt32());
                            break;
                        case "show_payments":
                            if (utf8JsonReader.TokenType != JsonTokenType.Null)
                                showPayments = new Option<bool?>(utf8JsonReader.GetBoolean());
                            break;
                        case "show_payment_method":
                            if (utf8JsonReader.TokenType != JsonTokenType.Null)
                                showPaymentMethod = new Option<bool?>(utf8JsonReader.GetBoolean());
                            break;
                        case "show_totals":
                        ...
                        case "show_notification_button":
                            if (utf8JsonReader.TokenType != JsonTokenType.Null)
                                showNotificationButton = new Option<bool?>(utf8JsonReader.GetBoolean());
                            break;
                        case "show_tspay_button":
                            if (utf8JsonReader.TokenType != JsonTokenType.Null)
                                showTspayButton = new Option<bool?>(utf8JsonReader.GetBoolean());
                            break;
                        case "delivery_note":
                            if (utf8JsonReader.TokenType != JsonTokenType.Null)
                                deliveryNote = new Option<bool?>(utf8JsonReader.GetBoolean());
                            break;
                        case "accompanying_invoice":
                            if (utf8JsonReader.TokenType != JsonTokenType.Null)
                                accompanyingInvoice = new Option<bool?>(utf8JsonReader.GetBoolean());
                            break;
                        case "dn_number":
                            if (utf8JsonReader.TokenType != JsonTokenType.Null)
                                dnNumber = new Option<int?>(utf8JsonReader.GetInt32());
                            break;
                        case "dn_date":
                            if (utf8JsonReader.TokenType != JsonTokenType.Null)
                        ...
                        case "is_marked":
                            if (utf8JsonReader.TokenType != JsonTokenType.Null)
                                isMarked = new Option<bool?>(utf8JsonReader.GetBoolean());
                            break;
                        case "amount_net":
                            if (utf8JsonReader.TokenType != JsonTokenType.Null)
                                amountNet = new Option<decimal?>(utf8JsonReader.GetDecimal());
                            break;
                        case "amount_vat":
                            if (utf8JsonReader.TokenType != JsonTokenType.Null)
                                amountVat = new Option<decimal?>(utf8JsonReader.GetDecimal());
                            break;
                        case "amount_gross":
                            if (utf8JsonReader.TokenType != JsonTokenType.Null)
                                amountGross = new Option<decimal?>(utf8JsonReader.GetDecimal());
                            break;
                        case "amount_due_discount":
                            if (utf8JsonReader.TokenType != JsonTokenType.Null)
                                amountDueDiscount = new Option<decimal?>(utf8JsonReader.GetDecimal());
                            break;
                        case "amount_rivalsa":
                            if (utf8JsonReader.TokenType != JsonTokenType.Null)
                                amountRivalsa = new Option<decimal?>(utf8JsonReader.GetDecimal());
                            break;
                        case "amount_rivalsa_taxable":
                            if (utf8JsonReader.TokenType != JsonTokenType.Null)
                                amountRivalsaTaxable = new Option<decimal?>(utf8JsonReader.GetDecimal());
                            break;
                        case "amount_withholding_tax":
                            if (utf8JsonReader.TokenType != JsonTokenType.Null)
                                amountWithholdingTax = new Option<decimal?>(utf8JsonReader.GetDecimal());
                            break;
                        case "amount_withholding_tax_taxable":
                            if (utf8JsonReader.TokenType != JsonTokenType.Null)
                                amountWithholdingTaxTaxable = new Option<decimal?>(utf8JsonReader.GetDecimal());
                            break;
                        case "amount_other_withholding_tax":
                            if (utf8JsonReader.TokenType != JsonTokenType.Null)
                                amountOtherWithholdingTax = new Option<decimal?>(utf8JsonReader.GetDecimal());
                            break;
                        case "amount_other_withholding_tax_taxable":
                            if (utf8JsonReader.TokenType != JsonTokenType.Null)
                                amountOtherWithholdingTaxTaxable = new Option<decimal?>(utf8JsonReader.GetDecimal());
                            break;
                        case "amount_enasarco_taxable":
                            if (utf8JsonReader.TokenType != JsonTokenType.Null)
                                amountEnasarcoTaxable = new Option<decimal?>(utf8JsonReader.GetDecimal());
                            break;
                        case "extra_data":
                            if (utf8JsonReader.TokenType != JsonTokenType.Null)
