...
namespace It.FattureInCloud.Sdk.Model
{
    ...
    public partial class IssuedDocumentItemsListItem : IEquatable<IssuedDocumentItemsListItem>, IValidatableObject
    {
        ...
        public IssuedDocumentItemsListItem(int id = default(int), int productId = default(int), string code = default(string), string name = default(string), string category = default(string), string description = default(string), decimal qty = default(decimal), string measure = default(string), decimal netPrice = default(decimal), decimal grossPrice = default(decimal), VatType vat = default(VatType), bool notTaxable = default(bool), bool applyWithholdingTaxes = default(bool), decimal discount = default(decimal), bool discountHighlight = default(bool), bool inDn = default(bool), bool stock = default(bool), Object eiRaw = default(Object))
        {
            this._Id = id;
            if (this.Id != null)
            {
            ...
            while (utf8JsonReader.Read())
            {
                ...
                if (utf8JsonReader.TokenType == JsonTokenType.PropertyName && currentDepth == utf8JsonReader.CurrentDepth - 1)
                {
                    ...
                    switch (localVarJsonPropertyName)
                    {
                        ...
                        case "qty":
                            if (utf8JsonReader.TokenType != JsonTokenType.Null)
                                qty = new Option<decimal?>(utf8JsonReader.GetDecimal());
                            break;
                        case "measure":
                        ...
                        case "net_price":
                            if (utf8JsonReader.TokenType != JsonTokenType.Null)
                                netPrice = new Option<decimal?>(utf8JsonReader.GetDecimal());
                            break;
                        case "gross_price":
                            if (utf8JsonReader.TokenType != JsonTokenType.Null)
                                grossPrice = new Option<decimal?>(utf8JsonReader.GetDecimal());
                            break;
                        case "vat":
                            if (utf8JsonReader.TokenType != JsonTokenType.Null)
                        ...
                        case "not_taxable":
                            if (utf8JsonReader.TokenType != JsonTokenType.Null)
                                notTaxable = new Option<bool?>(utf8JsonReader.GetBoolean());
                            break;
                        case "apply_withholding_taxes":
                            if (utf8JsonReader.TokenType != JsonTokenType.Null)
                                applyWithholdingTaxes = new Option<bool?>(utf8JsonReader.GetBoolean());
                            break;
                        case "discount":
                            if (utf8JsonReader.TokenType != JsonTokenType.Null)
                        ...
                        case "in_dn":
                            if (utf8JsonReader.TokenType != JsonTokenType.Null)
                                inDn = new Option<bool?>(utf8JsonReader.GetBoolean());
                            break;
                        case "stock":
                            if (utf8JsonReader.TokenType != JsonTokenType.Null)
