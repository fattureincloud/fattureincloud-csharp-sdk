...
namespace It.FattureInCloud.Sdk.Model
{
    ...
    public class ModifyReceivedDocumentRequest : IEquatable<ModifyReceivedDocumentRequest>, IValidatableObject
    {
        ...
        {
            return Equals(input as ModifyReceivedDocumentRequest);
        }
