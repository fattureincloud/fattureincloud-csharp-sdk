...
namespace It.FattureInCloud.Sdk.Model
{
    ...
    public class ListProductsResponse : IEquatable<ListProductsResponse>, IValidatableObject
    {
        ...
        public ListProductsResponse(int? currentPage = default(int?), string firstPageUrl = default(string),
            ...
            List<Product> data = default(List<Product>))
        {
        ...
        {
            return Equals(input as ListProductsResponse);
        }
