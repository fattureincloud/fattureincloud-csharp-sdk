...
namespace It.FattureInCloud.Sdk.Model
{
    ...
    public partial class PaymentMethod : IEquatable<PaymentMethod>, IValidatableObject
    {
        ...
        /// <param name="type">Method type (default to TypeEnum.Standard).</param>
        ...
        public PaymentMethod(int? id = default(int?), string name = default(string), TypeEnum? type = TypeEnum.Standard, bool isDefault = default(bool), PaymentAccount defaultPaymentAccount = default(PaymentAccount), List<PaymentMethodDetails> details = default(List<PaymentMethodDetails>), string bankIban = default(string), string bankName = default(string), string bankBeneficiary = default(string), string eiPaymentMethod = default(string))
        {
            this.Id = id;
            this.Name = name;
            this.Type = type;
        ...
        public List<PaymentMethodDetails> Details { get; set; }
