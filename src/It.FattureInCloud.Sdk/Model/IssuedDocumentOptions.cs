...
namespace It.FattureInCloud.Sdk.Model
{
    ...
    public class IssuedDocumentOptions : IEquatable<IssuedDocumentOptions>, IValidatableObject
    {
        ...
        public IssuedDocumentOptions(bool? fixPayments = default(bool?))
        {
            _FixPayments = fixPayments;
            if (FixPayments != null) _flagFixPayments = true;
        }
        ...
        {
            return Equals(input as IssuedDocumentOptions);
        }
        ...
        public bool Equals(IssuedDocumentOptions input)
        {
            ...
            return
                FixPayments == input.FixPayments ||
                (FixPayments != null &&
                 FixPayments.Equals(input.FixPayments));
        }
        ...
        public override int GetHashCode()
        {
            ...
            {
                int hashCode = 41;
                if (FixPayments != null) hashCode = hashCode * 59 + FixPayments.GetHashCode();
                return hashCode;
            }
        }
