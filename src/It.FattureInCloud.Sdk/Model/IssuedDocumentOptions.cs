                    ...
                    switch (localVarJsonPropertyName)
                    {
                        case "fix_payments":
                            if (utf8JsonReader.TokenType != JsonTokenType.Null)
                                fixPayments = new Option<bool?>(utf8JsonReader.GetBoolean());
                            break;
                        case "create_from":
                            if (utf8JsonReader.TokenType != JsonTokenType.Null)
                        ...
                        case "transform":
                            if (utf8JsonReader.TokenType != JsonTokenType.Null)
                                transform = new Option<bool?>(utf8JsonReader.GetBoolean());
                            break;
                        case "keep_copy":
                            if (utf8JsonReader.TokenType != JsonTokenType.Null)
                                keepCopy = new Option<bool?>(utf8JsonReader.GetBoolean());
                            break;
                        case "join_type":
