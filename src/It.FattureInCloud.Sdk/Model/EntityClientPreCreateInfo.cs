...
namespace It.FattureInCloud.Sdk.Model
{
    ...
    public partial class EntityClientPreCreateInfo : IEquatable<EntityClientPreCreateInfo>, IValidatableObject
    {
        ...
        public EntityClientPreCreateInfo(List<string> countriesList = default(List<string>), List<PaymentMethod> paymentMethodsList = default(List<PaymentMethod>), List<PaymentAccount> paymentAccountsList = default(List<PaymentAccount>), List<VatType> vatTypesList = default(List<VatType>), List<PriceList> priceLists = default(List<PriceList>), decimal limit = default(decimal), decimal usage = default(decimal))
        {
            ...
            while (utf8JsonReader.Read())
            {
                ...
                if (utf8JsonReader.TokenType == JsonTokenType.PropertyName && currentDepth == utf8JsonReader.CurrentDepth - 1)
                {
                    ...
                    switch (localVarJsonPropertyName)
                    {
                        ...
                        case "usage":
                            if (utf8JsonReader.TokenType != JsonTokenType.Null)
                                usage = new Option<decimal?>(utf8JsonReader.GetDecimal());
                            break;
                        default:
                            break;
                    }
