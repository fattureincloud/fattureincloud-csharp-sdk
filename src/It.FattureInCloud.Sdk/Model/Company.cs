...
namespace It.FattureInCloud.Sdk.Model
{
    ...
    public partial class Company : IValidatableObject
    {
        ...
        public Company(int? id = default(int?), string name = default(string), CompanyType? type = default(CompanyType?), string accessToken = default(string), List<ControlledCompany> controlledCompanies = default(List<ControlledCompany>), DateTime? ficLicenseExpire = default(DateTime?), FattureInCloudPlanType? ficPlan = default(FattureInCloudPlanType?), int? connectionId = default(int?), string taxCode = default(string))
        {
            this._Id = id;
            if (this.Id != null)
            {
