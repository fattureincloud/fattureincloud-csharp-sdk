...
namespace It.FattureInCloud.Sdk.Model
{
    ...
    public partial class Company : IEquatable<Company>, IValidatableObject
    {
        ...
        public Company(int id = default(int), string name = default(string), CompanyType? type = default(CompanyType?), string accessToken = default(string), List<ControlledCompany> controlledCompanies = default(List<ControlledCompany>), DateTimeOffset ficLicenseExpire = default(DateTimeOffset), FattureInCloudPlanType? ficPlan = default(FattureInCloudPlanType?), int connectionId = default(int), string taxCode = default(string), string vatNumber = default(string))
        {
            this._Id = id;
            if (this.Id != null)
            {
            ...
            while (utf8JsonReader.Read())
            {
                ...
                if (utf8JsonReader.TokenType == JsonTokenType.PropertyName && currentDepth == utf8JsonReader.CurrentDepth - 1)
                {
                    ...
                    switch (localVarJsonPropertyName)
                    {
                        ...
                        case "connection_id":
                            if (utf8JsonReader.TokenType != JsonTokenType.Null)
                                connectionId = new Option<int?>(utf8JsonReader.GetInt32());
                            break;
                        case "tax_code":
