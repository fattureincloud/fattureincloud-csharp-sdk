...
namespace It.FattureInCloud.Sdk.Model
{
    ...
    public partial class EmailScheduleInclude : IEquatable<EmailScheduleInclude>, IValidatableObject
    {
        ...
        protected EmailScheduleInclude() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="EmailScheduleInclude" /> class.
        /// </summary>
        /// <param name="document">If set to true, the email will have a button to view the document (required).</param>
        /// <param name="deliveryNote">If set to true, the email will have a button to view the delivery note (required).</param>
        /// <param name="attachment">If set to true, the email will have a button to view the attachment (required).</param>
        /// <param name="accompanyingInvoice">If set to true, the email will have a button to view the accompanying invoice (required).</param>
        ...
        [DataMember(Name = "delivery_note", IsRequired = true, EmitDefaultValue = true)]
        ...
        [DataMember(Name = "accompanying_invoice", IsRequired = true, EmitDefaultValue = true)]
