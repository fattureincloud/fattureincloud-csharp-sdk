...
namespace It.FattureInCloud.Sdk.Model
{
    ...
    public class ListSuppliersResponse : IEquatable<ListSuppliersResponse>, IValidatableObject
    {
        ...
        public ListSuppliersResponse(int? currentPage = default(int?), string firstPageUrl = default(string),
            ...
            List<Supplier> data = default(List<Supplier>))
        {
        ...
        {
            return Equals(input as ListSuppliersResponse);
        }
