...
namespace It.FattureInCloud.Sdk.Model
{
    ...
    public partial class CashbookEntryOut : IEquatable<CashbookEntryOut>, IValidatableObject
    {
        ...
        public CashbookEntryOut(string id = default(string), DateTimeOffset date = default(DateTimeOffset), string description = default(string), CashbookEntryKind? kind = default(CashbookEntryKind?), CashbookEntryType? type = default(CashbookEntryType?), string entityName = default(string), CashbookEntryDataDocument document = default(CashbookEntryDataDocument), decimal amountOut = default(decimal), PaymentAccount paymentAccountOut = default(PaymentAccount))
        {
            this.Id = id;
            this.Date = date;
