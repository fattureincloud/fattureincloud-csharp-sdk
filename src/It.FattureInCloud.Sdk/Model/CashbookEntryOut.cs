...
namespace It.FattureInCloud.Sdk.Model
{
    ...
    /// CashbookEntryOut
    /// </summary>
    [DataContract(Name = "CashbookEntryOut")]
    public partial class CashbookEntryOut : IEquatable<CashbookEntryOut>, IValidatableObject
    {
        /// <summary>
        /// Cashbook kind.
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="CashbookEntryOut" /> class.
        /// </summary>
        ...
        public CashbookEntryOut(string id = default(string), DateTimeOffset date = default(DateTimeOffset), string description = default(string), KindEnum? kind = default(KindEnum?), TypeEnum? type = default(TypeEnum?), string entityName = default(string), CashbookEntryDataDocument document = default(CashbookEntryDataDocument), decimal amountOut = default(decimal), PaymentAccount paymentAccountOut = default(PaymentAccount))
        {
            this.Id = id;
            this.Date = date;
        ...
        {
            return this.Equals(input as CashbookEntryOut);
        }

        /// <summary>
        /// Returns true if CashbookEntryOut instances are equal
        /// </summary>
        /// <param name="input">Instance of CashbookEntryOut to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CashbookEntryOut input)
        {
            if (input == null)
                return false;
