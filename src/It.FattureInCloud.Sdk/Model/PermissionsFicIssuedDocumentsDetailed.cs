...
namespace It.FattureInCloud.Sdk.Model
{
    ...
    public partial class PermissionsFicIssuedDocumentsDetailed : IEquatable<PermissionsFicIssuedDocumentsDetailed>, IValidatableObject
    {
        ...
        {
            this._Quotes = quotes;
            if (this.Quotes != null) this._flagQuotes = true;
            this._Proformas = proformas;
            if (this.Proformas != null) this._flagProformas = true;
            this._Invoices = invoices;
            if (this.Invoices != null) this._flagInvoices = true;
            this._Receipts = receipts;
            if (this.Receipts != null) this._flagReceipts = true;
            this._DeliveryNotes = deliveryNotes;
            if (this.DeliveryNotes != null) this._flagDeliveryNotes = true;
            this._CreditNotes = creditNotes;
            if (this.CreditNotes != null) this._flagCreditNotes = true;
            this._Orders = orders;
            if (this.Orders != null) this._flagOrders = true;
            this._WorkReports = workReports;
            if (this.WorkReports != null) this._flagWorkReports = true;
            this._SupplierOrders = supplierOrders;
            if (this.SupplierOrders != null) this._flagSupplierOrders = true;
            this._SelfInvoices = selfInvoices;
            if (this.SelfInvoices != null) this._flagSelfInvoices = true;
        }
