...
namespace It.FattureInCloud.Sdk.Model
{
    ...
    public partial class VatType : IEquatable<VatType>, IValidatableObject
    {
        ...
        public VatType(int id = default(int), decimal value = default(decimal), string description = default(string), string notes = default(string), bool eInvoice = default(bool), string eiType = default(string), string eiDescription = default(string), bool isDisabled = default(bool), bool varDefault = default(bool))
        {
            this._Id = id;
            if (this.Id != null)
            {
            ...
            while (utf8JsonReader.Read())
            {
                ...
                if (utf8JsonReader.TokenType == JsonTokenType.PropertyName && currentDepth == utf8JsonReader.CurrentDepth - 1)
                {
                    ...
                    switch (localVarJsonPropertyName)
                    {
                        ...
                        case "is_disabled":
                            if (utf8JsonReader.TokenType != JsonTokenType.Null)
                                isDisabled = new Option<bool?>(utf8JsonReader.GetBoolean());
                            break;
                        case "default":
                            if (utf8JsonReader.TokenType != JsonTokenType.Null)
