...
namespace It.FattureInCloud.Sdk.Model
{
    ...
    public partial class IssuedDocumentExtraData : IEquatable<IssuedDocumentExtraData>, IValidatableObject
    {
        ...
        /// <param name="debtVatDetect">Issued document debt VAT detect.</param>
        /// <param name="revenueDetect">Issued document revenue detect.</param>
        public IssuedDocumentExtraData(int? multifattureSent = default, bool? tsCommunication = default, decimal? tsFlagTipoSpesa = default, bool? tsPagamentoTracciato = default, string tsTipoSpesa = default, bool? tsOpposizione = default, int? tsStatus = default, string tsFileId = default, DateTime? tsSentDate = default, bool? tsFullAmount = default, string importedBy = default, bool? debtVatDetect = default, bool? revenueDetect = default)
        {
            ...
            this._DebtVatDetect = debtVatDetect;
            if (this.DebtVatDetect != null)
            {
                this._flagDebtVatDetect = true;
            }
            this._RevenueDetect = revenueDetect;
            if (this.RevenueDetect != null)
            {
                this._flagRevenueDetect = true;
            }
        }
        ...
        /// </summary>
        /// <value>Issued document debt VAT detect</value>
        [DataMember(Name = "debt_vat_detect", EmitDefaultValue = true)]
        public bool? DebtVatDetect
        {
            get { return _DebtVatDetect; }
            set
            {
                _DebtVatDetect = value;
                _flagDebtVatDetect = true;
            }
        }
        private bool? _DebtVatDetect;
        private bool _flagDebtVatDetect;

        /// <summary>
        /// Returns false as DebtVatDetect should not be serialized given that it's read-only.
        /// </summary>
        /// <returns>false (boolean)</returns>
        public bool ShouldSerializeDebtVatDetect()
        {
            return _flagDebtVatDetect;
        }
        /// <summary>
        /// Issued document revenue detect
        /// </summary>
        /// <value>Issued document revenue detect</value>
        [DataMember(Name = "revenue_detect", EmitDefaultValue = true)]
        public bool? RevenueDetect
        {
            get { return _RevenueDetect; }
            set
            {
                _RevenueDetect = value;
                _flagRevenueDetect = true;
            }
        }
        private bool? _RevenueDetect;
        private bool _flagRevenueDetect;

        /// <summary>
        /// Returns false as RevenueDetect should not be serialized given that it's read-only.
        /// </summary>
        /// <returns>false (boolean)</returns>
        public bool ShouldSerializeRevenueDetect()
        {
            return _flagRevenueDetect;
        }
        /// <summary>
        ...
        public bool Equals(IssuedDocumentExtraData input)
        {
            ...
            return
                ...
                (
                    this.DebtVatDetect == input.DebtVatDetect ||
                    (this.DebtVatDetect != null &&
                    this.DebtVatDetect.Equals(input.DebtVatDetect))
                ) &&
                (
                    this.RevenueDetect == input.RevenueDetect ||
                    (this.RevenueDetect != null &&
                    this.RevenueDetect.Equals(input.RevenueDetect))
                );
        }
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.DebtVatDetect != null)
                {
                    hashCode = (hashCode * 59) + this.DebtVatDetect.GetHashCode();
                }
                if (this.RevenueDetect != null)
                {
                    hashCode = (hashCode * 59) + this.RevenueDetect.GetHashCode();
                }
                return hashCode;
            }
        }
