...
namespace It.FattureInCloud.Sdk.Model
{
    ...
    public partial class IssuedDocumentExtraData : IEquatable<IssuedDocumentExtraData>, IValidatableObject
    {
        ...
        public DateTimeOffset TsSentDate
        {
        ...
        private DateTimeOffset _TsSentDate;
                    ...
                    switch (localVarJsonPropertyName)
                    {
                        case "multifatture_sent":
                            if (utf8JsonReader.TokenType != JsonTokenType.Null)
                                multifattureSent = new Option<int?>(utf8JsonReader.GetInt32());
                            break;
                        case "ts_communication":
                            if (utf8JsonReader.TokenType != JsonTokenType.Null)
                                tsCommunication = new Option<bool?>(utf8JsonReader.GetBoolean());
                            break;
                        case "ts_flag_tipo_spesa":
                            if (utf8JsonReader.TokenType != JsonTokenType.Null)
                                tsFlagTipoSpesa = new Option<decimal?>(utf8JsonReader.GetDecimal());
                            break;
                        case "ts_pagamento_tracciato":
                            if (utf8JsonReader.TokenType != JsonTokenType.Null)
                                tsPagamentoTracciato = new Option<bool?>(utf8JsonReader.GetBoolean());
                            break;
                        case "ts_tipo_spesa":
                        ...
                        case "ts_opposizione":
                            if (utf8JsonReader.TokenType != JsonTokenType.Null)
                                tsOpposizione = new Option<bool?>(utf8JsonReader.GetBoolean());
                            break;
                        case "ts_status":
                            if (utf8JsonReader.TokenType != JsonTokenType.Null)
                                tsStatus = new Option<int?>(utf8JsonReader.GetInt32());
                            break;
                        case "ts_file_id":
                        ...
                        case "ts_full_amount":
                            if (utf8JsonReader.TokenType != JsonTokenType.Null)
                                tsFullAmount = new Option<bool?>(utf8JsonReader.GetBoolean());
                            break;
                        case "imported_by":
