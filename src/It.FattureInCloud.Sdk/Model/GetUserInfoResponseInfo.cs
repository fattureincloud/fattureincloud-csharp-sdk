                    ...
                    switch (localVarJsonPropertyName)
                    {
                        case "need_marketing_consents_confirmation":
                            if (utf8JsonReader.TokenType != JsonTokenType.Null)
                                needMarketingConsentsConfirmation = new Option<bool?>(utf8JsonReader.GetBoolean());
                            break;
                        case "need_password_change":
                            if (utf8JsonReader.TokenType != JsonTokenType.Null)
                                needPasswordChange = new Option<bool?>(utf8JsonReader.GetBoolean());
                            break;
                        case "need_terms_of_service_confirmation":
                            if (utf8JsonReader.TokenType != JsonTokenType.Null)
                                needTermsOfServiceConfirmation = new Option<bool?>(utf8JsonReader.GetBoolean());
                            break;
                        default:
                            break;
                    }
