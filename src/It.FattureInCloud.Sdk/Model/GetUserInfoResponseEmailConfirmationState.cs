...
namespace It.FattureInCloud.Sdk.Model
{
    ...
    public class GetUserInfoResponseEmailConfirmationState : IEquatable<GetUserInfoResponseEmailConfirmationState>,
        IValidatableObject
    {
        ...
        {
            _NeedConfirmation = needConfirmation;
            if (NeedConfirmation != null) _flagNeedConfirmation = true;
        }
        ...
        {
            return Equals(input as GetUserInfoResponseEmailConfirmationState);
        }
        ...
        public bool Equals(GetUserInfoResponseEmailConfirmationState input)
        {
            ...
            return
                NeedConfirmation == input.NeedConfirmation ||
                (NeedConfirmation != null &&
                 NeedConfirmation.Equals(input.NeedConfirmation));
        }
        ...
        public override int GetHashCode()
        {
            ...
            {
                int hashCode = 41;
                if (NeedConfirmation != null) hashCode = hashCode * 59 + NeedConfirmation.GetHashCode();
                return hashCode;
            }
        }
