...
namespace It.FattureInCloud.Sdk.Model
{
    ...
    public class VerifyEInvoiceXmlErrorResponseExtra : IEquatable<VerifyEInvoiceXmlErrorResponseExtra>,
        IValidatableObject
    {
        ...
        {
            _Errors = errors;
            if (Errors != null) _flagErrors = true;
        }
        ...
        {
            return Equals(input as VerifyEInvoiceXmlErrorResponseExtra);
        }
