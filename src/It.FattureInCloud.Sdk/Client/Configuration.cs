...
namespace It.FattureInCloud.Sdk.Client
{
    ...
    public class Configuration : IReadableConfiguration
    {
        ...
        {
            Proxy = null;
            UserAgent = WebUtility.UrlEncode("FattureInCloud/2.0.18/csharp-SDK");
        ...
        public Configuration(
            ...
            string basePath = "https://api-v2.fattureincloud.it") : this()
        {
        ...
        {
            string report = "C# SDK (It.FattureInCloud.Sdk) Debug Report:\n";
            report += "    OS: " + System.Environment.OSVersion + "\n";
            report += "    .NET Framework Version: " + System.Environment.Version + "\n";
            report += "    Version of the API: 2.0.25\n";
            report += "    SDK Package Version: 2.0.18\n";
