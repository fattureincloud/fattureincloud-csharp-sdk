...
namespace It.FattureInCloud.Sdk.Api
{
    ...
    public interface IEmailsApiSync : IApiAccessor
    {
        ...
        ListEmailsResponse ListEmails(int companyId, string fields = default(string), string fieldset = default(string), string sort = default(string), int page = default(int), int perPage = default(int), string q = default(string), int operationIndex = 0);
        ...
        ApiResponse<ListEmailsResponse> ListEmailsWithHttpInfo(int companyId, string fields = default(string), string fieldset = default(string), string sort = default(string), int page = default(int), int perPage = default(int), string q = default(string), int operationIndex = 0);
    ...
    public interface IEmailsApiAsync : IApiAccessor
    {
        ...
        System.Threading.Tasks.Task<ApiResponse<ListEmailsResponse>> ListEmailsWithHttpInfoAsync(int companyId, string fields = default(string), string fieldset = default(string), string sort = default(string), int page = default(int), int perPage = default(int), string q = default(string), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(global::System.Threading.CancellationToken));
    ...
    public partial class EmailsApi : IEmailsApi
    {
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ListEmailsResponse</returns>
        public ListEmailsResponse ListEmails(int companyId, string fields = default(string), string fieldset = default(string), string sort = default(string), int page = default(int), int perPage = default(int), string q = default(string), int operationIndex = 0)
        {
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of ListEmailsResponse</returns>
        public It.FattureInCloud.Sdk.Client.ApiResponse<ListEmailsResponse> ListEmailsWithHttpInfo(int companyId, string fields = default(string), string fieldset = default(string), string sort = default(string), int page = default(int), int perPage = default(int), string q = default(string), int operationIndex = 0)
        {
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (ListEmailsResponse)</returns>
        public async System.Threading.Tasks.Task<It.FattureInCloud.Sdk.Client.ApiResponse<ListEmailsResponse>> ListEmailsWithHttpInfoAsync(int companyId, string fields = default(string), string fieldset = default(string), string sort = default(string), int page = default(int), int perPage = default(int), string q = default(string), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'companyId' is set
            if (companyId == null)
            {
