...
namespace It.FattureInCloud.Sdk.Api
{
    ...
    public interface IProductsApiAsync : IApiAccessor
    {
        ...
        System.Threading.Tasks.Task<CreateProductResponse> CreateProductAsync(int companyId, CreateProductRequest createProductRequest = default(CreateProductRequest), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        ...
        System.Threading.Tasks.Task<ApiResponse<CreateProductResponse>> CreateProductWithHttpInfoAsync(int companyId, CreateProductRequest createProductRequest = default(CreateProductRequest), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        /// <summary>
        /// Delete Product
        /// </summary>
        /// <remarks>
        ...
        System.Threading.Tasks.Task DeleteProductAsync(int companyId, int productId, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        ...
        System.Threading.Tasks.Task<ApiResponse<Object>> DeleteProductWithHttpInfoAsync(int companyId, int productId, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        /// <summary>
        /// Get Product
        /// </summary>
        /// <remarks>
        ...
        System.Threading.Tasks.Task<GetProductResponse> GetProductAsync(int companyId, int productId, string fields = default(string), string fieldset = default(string), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        ...
        System.Threading.Tasks.Task<ApiResponse<GetProductResponse>> GetProductWithHttpInfoAsync(int companyId, int productId, string fields = default(string), string fieldset = default(string), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        /// <summary>
        /// List Products
        /// </summary>
        /// <remarks>
        ...
        System.Threading.Tasks.Task<ModifyProductResponse> ModifyProductAsync(int companyId, int productId, ModifyProductRequest modifyProductRequest = default(ModifyProductRequest), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
