...
namespace It.FattureInCloud.Sdk.Api
{
    ...
    public interface ICashbookApiAsync : IApiAccessor
    {
        ...
        System.Threading.Tasks.Task DeleteCashbookEntryAsync(int companyId, string documentId, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        ...
        System.Threading.Tasks.Task<ApiResponse<Object>> DeleteCashbookEntryWithHttpInfoAsync(int companyId, string documentId, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        /// <summary>
        /// Get Cashbook Entry
        /// </summary>
        /// <remarks>
        ...
        System.Threading.Tasks.Task<GetCashbookEntryResponse> GetCashbookEntryAsync(int companyId, string documentId, string fields = default(string), string fieldset = default(string), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        ...
        System.Threading.Tasks.Task<ModifyCashbookEntryResponse> ModifyCashbookEntryAsync(int companyId, string documentId, ModifyCashbookEntryRequest modifyCashbookEntryRequest = default(ModifyCashbookEntryRequest), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        ...
        System.Threading.Tasks.Task<ApiResponse<ModifyCashbookEntryResponse>> ModifyCashbookEntryWithHttpInfoAsync(int companyId, string documentId, ModifyCashbookEntryRequest modifyCashbookEntryRequest = default(ModifyCashbookEntryRequest), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
