...
namespace It.FattureInCloud.Sdk.Api
{
    ...
    public interface IIssuedDocumentsApiSync : IApiAccessor
    {
        ...
        TransformIssuedDocumentResponse TransformIssuedDocument(int companyId, decimal originalDocumentId, string newType, int? eInvoice = default(int?), int? transformKeepCopy = default(int?), int operationIndex = 0);
        ...
        ApiResponse<TransformIssuedDocumentResponse> TransformIssuedDocumentWithHttpInfo(int companyId, decimal originalDocumentId, string newType, int? eInvoice = default(int?), int? transformKeepCopy = default(int?), int operationIndex = 0);
        /// <summary>
    ...
    public partial class IssuedDocumentsApi : IIssuedDocumentsApi
    {
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>TransformIssuedDocumentResponse</returns>
        public TransformIssuedDocumentResponse TransformIssuedDocument(int companyId, decimal originalDocumentId, string newType, int? eInvoice = default(int?), int? transformKeepCopy = default(int?), int operationIndex = 0)
        {
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of TransformIssuedDocumentResponse</returns>
        public It.FattureInCloud.Sdk.Client.ApiResponse<TransformIssuedDocumentResponse> TransformIssuedDocumentWithHttpInfo(int companyId, decimal originalDocumentId, string newType, int? eInvoice = default(int?), int? transformKeepCopy = default(int?), int operationIndex = 0)
        {
