...
namespace It.FattureInCloud.Sdk.Api
{
    ...
    public interface IClientsApiAsync : IApiAccessor
    {
        ...
        System.Threading.Tasks.Task<CreateClientResponse> CreateClientAsync(int companyId, CreateClientRequest createClientRequest = default(CreateClientRequest), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        ...
        System.Threading.Tasks.Task<ApiResponse<CreateClientResponse>> CreateClientWithHttpInfoAsync(int companyId, CreateClientRequest createClientRequest = default(CreateClientRequest), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        /// <summary>
        /// Delete Client
        /// </summary>
        /// <remarks>
        ...
        System.Threading.Tasks.Task DeleteClientAsync(int companyId, int clientId, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        ...
        System.Threading.Tasks.Task<ApiResponse<Object>> DeleteClientWithHttpInfoAsync(int companyId, int clientId, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        /// <summary>
        /// Get Client
        /// </summary>
        /// <remarks>
        ...
        System.Threading.Tasks.Task<GetClientResponse> GetClientAsync(int companyId, int clientId, string fields = default(string), string fieldset = default(string), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        ...
        System.Threading.Tasks.Task<ApiResponse<GetClientResponse>> GetClientWithHttpInfoAsync(int companyId, int clientId, string fields = default(string), string fieldset = default(string), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        /// <summary>
        /// List Clients
        /// </summary>
        /// <remarks>
        ...
        System.Threading.Tasks.Task<ModifyClientResponse> ModifyClientAsync(int companyId, int clientId, ModifyClientRequest modifyClientRequest = default(ModifyClientRequest), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
