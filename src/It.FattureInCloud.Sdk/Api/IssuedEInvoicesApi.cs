...
namespace It.FattureInCloud.Sdk.Api
{
    ...
    public interface IIssuedEInvoicesApiAsync : IApiAccessor
    {
        ...
        System.Threading.Tasks.Task<GetEInvoiceRejectionReasonResponse> GetEInvoiceRejectionReasonAsync(int companyId, int documentId, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        ...
        System.Threading.Tasks.Task<ApiResponse<GetEInvoiceRejectionReasonResponse>> GetEInvoiceRejectionReasonWithHttpInfoAsync(int companyId, int documentId, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        /// <summary>
        /// Get e-invoice XML
        /// </summary>
        /// <remarks>
        ...
        System.Threading.Tasks.Task<string> GetEInvoiceXmlAsync(int companyId, int documentId, bool? includeAttachment = default(bool?), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        ...
        System.Threading.Tasks.Task<ApiResponse<string>> GetEInvoiceXmlWithHttpInfoAsync(int companyId, int documentId, bool? includeAttachment = default(bool?), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        /// <summary>
        /// Send the e-invoice
        /// </summary>
        /// <remarks>
        ...
        System.Threading.Tasks.Task<SendEInvoiceResponse> SendEInvoiceAsync(int companyId, int documentId, SendEInvoiceRequest sendEInvoiceRequest = default(SendEInvoiceRequest), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        ...
        System.Threading.Tasks.Task<VerifyEInvoiceXmlResponse> VerifyEInvoiceXmlAsync(int companyId, int documentId, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        ...
        System.Threading.Tasks.Task<ApiResponse<VerifyEInvoiceXmlResponse>> VerifyEInvoiceXmlWithHttpInfoAsync(int companyId, int documentId, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
