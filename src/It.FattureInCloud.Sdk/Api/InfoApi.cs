...
namespace It.FattureInCloud.Sdk.Api
{
    ...
    public interface IInfoApiSync : IApiAccessor
    {
        ...
        ListTemplatesResponse ListDefaultTemplates(string type = default, bool? byType = default, int operationIndex = 0);
        ...
        ApiResponse<ListTemplatesResponse> ListDefaultTemplatesWithHttpInfo(string type = default, bool? byType = default, int operationIndex = 0);
        /// <summary>
    ...
    public interface IInfoApiAsync : IApiAccessor
    {
        ...
        System.Threading.Tasks.Task<ListTemplatesResponse> ListDefaultTemplatesAsync(string type = default, bool? byType = default, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default);
        ...
        System.Threading.Tasks.Task<ApiResponse<ListTemplatesResponse>> ListDefaultTemplatesWithHttpInfoAsync(string type = default, bool? byType = default, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default);
        /// <summary>
        /// List Delivery Notes Default Causals
        /// </summary>
        /// <remarks>
    ...
    public partial class InfoApi : IInfoApi
    {
        ...
        /// <summary>
        /// List Default Templates Lists the default available templates.
        /// </summary>
        /// <exception cref="It.FattureInCloud.Sdk.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="type">Type of the templates. (optional, default to all)</param>
        /// <param name="byType">[Only if type&#x3D;all] If true, splits the list in objects, grouping templates by type. (optional, default to false)</param>
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ListTemplatesResponse</returns>
        public ListTemplatesResponse ListDefaultTemplates(string type = default, bool? byType = default, int operationIndex = 0)
        {
            It.FattureInCloud.Sdk.Client.ApiResponse<ListTemplatesResponse> localVarResponse = ListDefaultTemplatesWithHttpInfo(type, byType);
            return localVarResponse.Data;
        }
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of ListTemplatesResponse</returns>
        public It.FattureInCloud.Sdk.Client.ApiResponse<ListTemplatesResponse> ListDefaultTemplatesWithHttpInfo(string type = default, bool? byType = default, int operationIndex = 0)
        {
            It.FattureInCloud.Sdk.Client.RequestOptions localVarRequestOptions = new It.FattureInCloud.Sdk.Client.RequestOptions();
            ...
            localVarRequestOptions.Operation = "InfoApi.ListDefaultTemplates";
            localVarRequestOptions.OperationIndex = operationIndex;
            ...
            if (this.ExceptionFactory != null)
            {
                Exception _exception = this.ExceptionFactory("ListDefaultTemplates", localVarResponse);
                if (_exception != null)
                {
                    throw _exception;
                }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ListTemplatesResponse</returns>
        public async System.Threading.Tasks.Task<ListTemplatesResponse> ListDefaultTemplatesAsync(string type = default, bool? byType = default, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default)
        {
            It.FattureInCloud.Sdk.Client.ApiResponse<ListTemplatesResponse> localVarResponse = await ListDefaultTemplatesWithHttpInfoAsync(type, byType, operationIndex, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (ListTemplatesResponse)</returns>
        public async System.Threading.Tasks.Task<It.FattureInCloud.Sdk.Client.ApiResponse<ListTemplatesResponse>> ListDefaultTemplatesWithHttpInfoAsync(string type = default, bool? byType = default, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default)
        {
