...
namespace It.FattureInCloud.Sdk.Api
{
    ...
    public interface IReceivedDocumentsApiAsync : IApiAccessor
    {
        ...
        System.Threading.Tasks.Task DeleteReceivedDocumentAsync(int companyId, int documentId, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        ...
        System.Threading.Tasks.Task<ApiResponse<Object>> DeleteReceivedDocumentWithHttpInfoAsync(int companyId, int documentId, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        /// <summary>
        /// Delete Received Document Attachment
        /// </summary>
        /// <remarks>
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of void</returns>
        System.Threading.Tasks.Task DeleteReceivedDocumentAttachmentAsync(int companyId, int documentId, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse</returns>
        System.Threading.Tasks.Task<ApiResponse<Object>> DeleteReceivedDocumentAttachmentWithHttpInfoAsync(int companyId, int documentId, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        /// <summary>
        /// Get Existing Received Document Totals
        /// </summary>
        /// <remarks>
        ...
        System.Threading.Tasks.Task<GetReceivedDocumentResponse> GetReceivedDocumentAsync(int companyId, int documentId, string fields = default(string), string fieldset = default(string), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        ...
        System.Threading.Tasks.Task<GetReceivedDocumentPreCreateInfoResponse> GetReceivedDocumentPreCreateInfoAsync(int companyId, string type, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        ...
        System.Threading.Tasks.Task<ApiResponse<GetReceivedDocumentPreCreateInfoResponse>> GetReceivedDocumentPreCreateInfoWithHttpInfoAsync(int companyId, string type, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        /// <summary>
        /// List Received Documents
        /// </summary>
        /// <remarks>
